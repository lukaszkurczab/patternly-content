...
unitKind: "contrast"
unitId: "transfer_binary_search_vs_linear_scan"
contentOwnership: "cross_family"
primaryPatternFamilyId: "binary_search"
legalPatternFamilyIds:
  - "binary_search"
  - "arrays_and_strings"
primarySkillAtomId: "transfer_binary_search_vs_scan_decision"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-binary-search-vs-linear-scan/transfer-binary-search-vs-linear-scan.json"
...
Teach `transfer_binary_search_vs_scan_decision` as the primary diagnostic target for `transfer_binary_search_vs_linear_scan` in `contrast_binary_search_vs_linear_scan`.
