...
| --- | ---: |
| Object, file, and block workload signals | 18 |
| S3 performance and scalable object access | 18 |
| EBS volume type, IOPS, and throughput decisions | 22 |
| EFS and FSx workload fit | 22 |
| Hybrid storage and Storage Gateway | 22 |
| DataSync and future-capacity design | 22 |
| **Total** | **124** |

Verification:

- \`npm run audit:aws-workbook-source\` — PASS
- All six blocks use the canonical N12 node and block ownership.
- Each item has one accepted choice, complete distractor explanations, explicit constraints, and first-party AWS source bindings.
