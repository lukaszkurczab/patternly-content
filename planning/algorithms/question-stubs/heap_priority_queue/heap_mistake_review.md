...
futureCanonicalSourcePath: "manual/source/algorithms/heap-priority-queue/heap-mistake-review.json"
...
Teach `diagnose_heap_state_mismatch` as the primary diagnostic target for `heap_mistake_review` in `heap_priority_queue`.
