...
unitKind: "contrast"
unitId: "correctness_invariant_comparison"
contentOwnership: "cross_family"
primaryPatternFamilyId: "stack"
legalPatternFamilyIds:
  - "stack"
  - "monotonic_stack"
primarySkillAtomId: "compare_stack_and_monotonic_stack_invariants"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-stack-vs-monotonic-stack-intro/correctness-invariant-comparison.json"
...
Teach `compare_stack_and_monotonic_stack_invariants` as the primary diagnostic target for `correctness_invariant_comparison` in `contrast_stack_vs_monotonic_stack_intro`.
