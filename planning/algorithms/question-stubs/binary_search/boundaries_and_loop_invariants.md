...
unitKind: "direct"
unitId: "boundaries_and_loop_invariants"
contentOwnership: "direct"
primaryPatternFamilyId: "binary_search"
legalPatternFamilyIds:
  - "binary_search"
primarySkillAtomId: "preserve_binary_search_boundary_contract"
...
futureCanonicalSourcePath: "manual/source/algorithms/binary-search/boundaries-and-loop-invariants.json"
...
Teach `preserve_binary_search_boundary_contract` as the primary diagnostic target for `boundaries_and_loop_invariants` in `binary_search`.
