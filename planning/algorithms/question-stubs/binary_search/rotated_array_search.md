...
unitKind: "direct"
unitId: "rotated_array_search"
contentOwnership: "direct"
primaryPatternFamilyId: "binary_search"
legalPatternFamilyIds:
  - "binary_search"
primarySkillAtomId: "identify_ordered_half_in_rotated_input"
...
futureCanonicalSourcePath: "manual/source/algorithms/binary-search/rotated-array-search.json"
...
Teach `identify_ordered_half_in_rotated_input` as the primary diagnostic target for `rotated_array_search` in `binary_search`.
