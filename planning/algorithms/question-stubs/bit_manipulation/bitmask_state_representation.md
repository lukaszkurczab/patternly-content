...
futureCanonicalSourcePath: "manual/source/algorithms/bit-manipulation/bitmask-state-representation.json"
...
Teach `encode_boolean_state_in_mask` as the primary diagnostic target for `bitmask_state_representation` in `bit_manipulation`.
