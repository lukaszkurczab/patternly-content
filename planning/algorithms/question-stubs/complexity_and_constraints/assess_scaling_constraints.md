...
futureCanonicalSourcePath: "manual/source/algorithms/complexity-and-constraints/assess-scaling-constraints.json"
...
Teach `translate_constraints_to_operation_budget` as the primary diagnostic target for `assess_scaling_constraints` in `complexity_and_constraints`.
