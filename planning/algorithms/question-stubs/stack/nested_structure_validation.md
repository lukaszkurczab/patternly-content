...
roadmapNodeId: "stack"
unitKind: "direct"
unitId: "nested_structure_validation"
contentOwnership: "direct"
primaryPatternFamilyId: "stack"
legalPatternFamilyIds:
  - "stack"
primarySkillAtomId: "match_nested_structure_with_stack"
...
futureCanonicalSourcePath: "manual/source/algorithms/stack/nested-structure-validation.json"
...
Teach `match_nested_structure_with_stack` as the primary diagnostic target for `nested_structure_validation` in `stack`.
