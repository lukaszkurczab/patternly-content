...
futureCanonicalSourcePath: "manual/source/algorithms/complexity-and-constraints/amortized-complexity.json"
...
Teach `distinguish_amortized_from_worst_case` as the primary diagnostic target for `amortized_complexity` in `complexity_and_constraints`.
