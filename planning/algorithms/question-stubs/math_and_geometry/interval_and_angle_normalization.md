...
unitKind: "direct"
unitId: "interval_and_angle_normalization"
contentOwnership: "direct"
primaryPatternFamilyId: "math_and_geometry"
legalPatternFamilyIds:
  - "math_and_geometry"
primarySkillAtomId: "normalize_cyclic_or_coordinate_value"
...
futureCanonicalSourcePath: "manual/source/algorithms/math-and-geometry/interval-and-angle-normalization.json"
...
Teach `normalize_cyclic_or_coordinate_value` as the primary diagnostic target for `interval_and_angle_normalization` in `math_and_geometry`.
