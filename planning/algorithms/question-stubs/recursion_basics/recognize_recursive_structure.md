...
unitKind: "direct"
unitId: "recognize_recursive_structure"
contentOwnership: "direct"
primaryPatternFamilyId: "recursion_basics"
legalPatternFamilyIds:
  - "recursion_basics"
primarySkillAtomId: "identify_self_similar_subproblem"
...
futureCanonicalSourcePath: "manual/source/algorithms/recursion-basics/recognize-recursive-structure.json"
...
Teach `identify_self_similar_subproblem` as the primary diagnostic target for `recognize_recursive_structure` in `recursion_basics`.
