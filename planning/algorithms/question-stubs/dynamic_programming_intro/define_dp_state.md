...
futureCanonicalSourcePath: "manual/source/algorithms/dynamic-programming-intro/define-dp-state.json"
...
Teach `define_sufficient_dp_state` as the primary diagnostic target for `define_dp_state` in `dynamic_programming_intro`.
