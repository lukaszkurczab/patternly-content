...
export function validateCertificationCurriculum(curriculum, { brief, registry }) {
  ...
  const allowedVersion = curriculum.curriculumVersion === "2026.08.11" || (curriculum.trackId === "microsoft-azure-ai-fundamentals-ai-901" && curriculum.curriculumVersion === "2026.08.15");
