...
unitKind: "contrast"
unitId: "nested_structure_vs_nearest_greater_problem"
contentOwnership: "cross_family"
primaryPatternFamilyId: "stack"
legalPatternFamilyIds:
  - "stack"
  - "monotonic_stack"
primarySkillAtomId: "distinguish_nested_validation_from_nearest_boundary"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-stack-vs-monotonic-stack-intro/nested-structure-vs-nearest-greater-problem.json"
...
Teach `distinguish_nested_validation_from_nearest_boundary` as the primary diagnostic target for `nested_structure_vs_nearest_greater_problem` in `contrast_stack_vs_monotonic_stack_intro`.
