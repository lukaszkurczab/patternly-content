...
unitKind: "contrast"
unitId: "unresolved_state_vs_dominated_candidate"
contentOwnership: "cross_family"
primaryPatternFamilyId: "stack"
legalPatternFamilyIds:
  - "stack"
  - "monotonic_stack"
primarySkillAtomId: "distinguish_recent_unresolved_from_dominated_candidate"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-stack-vs-monotonic-stack-intro/unresolved-state-vs-dominated-candidate.json"
...
Teach `distinguish_recent_unresolved_from_dominated_candidate` as the primary diagnostic target for `unresolved_state_vs_dominated_candidate` in `contrast_stack_vs_monotonic_stack_intro`.
