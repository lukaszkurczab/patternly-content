...
unitKind: "strategy"
unitId: "correctness_before_optimization"
...
legalPatternFamilyIds:
  ...
  - "monotonic_stack"
  - "binary_search"
primarySkillAtomId: "prioritize_correctness_before_asymptotic_speed"
...
futureCanonicalSourcePath: "manual/source/algorithms/strategy-selection-core/correctness-before-optimization.json"
...
Teach `prioritize_correctness_before_asymptotic_speed` as the primary diagnostic target for `correctness_before_optimization` in `strategy_selection_core`.
