...
futureCanonicalSourcePath: "manual/source/algorithms/heap-priority-queue/min-heap-vs-max-heap-choice.json"
...
Teach `choose_heap_orientation` as the primary diagnostic target for `min_heap_vs_max_heap_choice` in `heap_priority_queue`.
