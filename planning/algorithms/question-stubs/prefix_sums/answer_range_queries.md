...
unitKind: "direct"
unitId: "answer_range_queries"
contentOwnership: "direct"
primaryPatternFamilyId: "prefix_sums"
legalPatternFamilyIds:
  - "prefix_sums"
primarySkillAtomId: "derive_range_from_prefix_difference"
...
futureCanonicalSourcePath: "manual/source/algorithms/prefix-sums/answer-range-queries.json"
...
Teach `derive_range_from_prefix_difference` as the primary diagnostic target for `answer_range_queries` in `prefix_sums`.
