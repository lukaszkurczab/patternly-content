...
unitKind: "direct"
unitId: "preserve_indices_and_provenance"
contentOwnership: "direct"
primaryPatternFamilyId: "hash_map_and_set"
legalPatternFamilyIds:
  - "hash_map_and_set"
primarySkillAtomId: "preserve_original_index_in_lookup_state"
...
futureCanonicalSourcePath: "manual/source/algorithms/hash-map-and-set/preserve-indices-and-provenance.json"
...
Teach `preserve_original_index_in_lookup_state` as the primary diagnostic target for `preserve_indices_and_provenance` in `hash_map_and_set`.
