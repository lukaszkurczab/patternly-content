...
unitKind: "direct"
unitId: "prefix_vs_window_tradeoff"
contentOwnership: "direct"
primaryPatternFamilyId: "prefix_sums"
legalPatternFamilyIds:
  - "prefix_sums"
primarySkillAtomId: "choose_prefix_over_moving_window"
...
futureCanonicalSourcePath: "manual/source/algorithms/prefix-sums/prefix-vs-window-tradeoff.json"
...
Teach `choose_prefix_over_moving_window` as the primary diagnostic target for `prefix_vs_window_tradeoff` in `prefix_sums`.
