...
unitKind: "direct"
unitId: "two_dimensional_prefix"
contentOwnership: "direct"
primaryPatternFamilyId: "prefix_sums"
legalPatternFamilyIds:
  - "prefix_sums"
primarySkillAtomId: "derive_matrix_region_from_prefixes"
...
futureCanonicalSourcePath: "manual/source/algorithms/prefix-sums/two-dimensional-prefix.json"
...
Teach `derive_matrix_region_from_prefixes` as the primary diagnostic target for `two_dimensional_prefix` in `prefix_sums`.
