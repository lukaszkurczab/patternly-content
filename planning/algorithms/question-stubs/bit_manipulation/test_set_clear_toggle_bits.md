...
futureCanonicalSourcePath: "manual/source/algorithms/bit-manipulation/test-set-clear-toggle-bits.json"
...
Teach `manipulate_selected_bit` as the primary diagnostic target for `test_set_clear_toggle_bits` in `bit_manipulation`.
