...
futureCanonicalSourcePath: "manual/source/algorithms/backtracking/duplicate-control.json"
...
Teach `prevent_duplicate_search_results` as the primary diagnostic target for `duplicate_control` in `backtracking`.
