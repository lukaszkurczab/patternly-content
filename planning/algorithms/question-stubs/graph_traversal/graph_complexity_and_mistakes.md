...
unitKind: "direct"
unitId: "graph_complexity_and_mistakes"
contentOwnership: "direct"
primaryPatternFamilyId: "graph_traversal"
legalPatternFamilyIds:
  - "graph_traversal"
primarySkillAtomId: "derive_graph_traversal_complexity"
...
futureCanonicalSourcePath: "manual/source/algorithms/graph-traversal/graph-complexity-and-mistakes.json"
...
Teach `derive_graph_traversal_complexity` as the primary diagnostic target for `graph_complexity_and_mistakes` in `graph_traversal`.
