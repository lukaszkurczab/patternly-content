...
unitKind: "direct"
unitId: "answer_update_and_boundaries"
contentOwnership: "direct"
primaryPatternFamilyId: "sliding_window"
legalPatternFamilyIds:
  - "sliding_window"
primarySkillAtomId: "update_window_answer_at_legal_state"
...
futureCanonicalSourcePath: "manual/source/algorithms/sliding-window/answer-update-and-boundaries.json"
...
Teach `update_window_answer_at_legal_state` as the primary diagnostic target for `answer_update_and_boundaries` in `sliding_window`.
