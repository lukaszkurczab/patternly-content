...
futureCanonicalSourcePath: "manual/source/algorithms/dynamic-programming-intro/define-transition.json"
...
Teach `derive_dp_transition` as the primary diagnostic target for `define_transition` in `dynamic_programming_intro`.
