...
futureCanonicalSourcePath: "manual/source/algorithms/math-and-geometry/gcd-lcm-and-divisibility.json"
...
Teach `apply_euclidean_algorithm` as the primary diagnostic target for `gcd_lcm_and_divisibility` in `math_and_geometry`.
