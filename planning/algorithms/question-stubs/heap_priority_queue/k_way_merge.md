...
legalPatternFamilyIds:
  - "heap_priority_queue"
primarySkillAtomId: "merge_sorted_sources_with_heap"
...
futureCanonicalSourcePath: "manual/source/algorithms/heap-priority-queue/k-way-merge.json"
...
Teach `merge_sorted_sources_with_heap` as the primary diagnostic target for `k_way_merge` in `heap_priority_queue`.
