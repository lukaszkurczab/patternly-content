...
futureCanonicalSourcePath: "manual/source/algorithms/sliding-window/expand-shrink-update-order.json"
...
Teach `order_window_state_updates` as the primary diagnostic target for `expand_shrink_update_order` in `sliding_window`.
