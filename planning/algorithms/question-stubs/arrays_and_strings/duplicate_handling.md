...
futureCanonicalSourcePath: "manual/source/algorithms/arrays-and-strings/duplicate-handling.json"
...
Teach `preserve_duplicate_contract` as the primary diagnostic target for `duplicate_handling` in `arrays_and_strings`.
