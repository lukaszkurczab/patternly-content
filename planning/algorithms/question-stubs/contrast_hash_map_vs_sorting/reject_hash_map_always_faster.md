...
unitKind: "contrast"
unitId: "reject_hash_map_always_faster"
contentOwnership: "cross_family"
primaryPatternFamilyId: "hash_map_and_set"
legalPatternFamilyIds:
  - "hash_map_and_set"
  - "sorting_based"
primarySkillAtomId: "reject_hash_map_always_faster_heuristic"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-hash-map-vs-sorting/reject-hash-map-always-faster.json"
...
Teach `reject_hash_map_always_faster_heuristic` as the primary diagnostic target for `reject_hash_map_always_faster` in `contrast_hash_map_vs_sorting`.
