...
unitKind: "contrast"
unitId: "single_pass_vs_repeated_queries"
contentOwnership: "cross_family"
primaryPatternFamilyId: "hash_map_and_set"
legalPatternFamilyIds:
  - "hash_map_and_set"
  - "sorting_based"
primarySkillAtomId: "choose_hash_or_sort_for_query_volume"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-hash-map-vs-sorting/single-pass-vs-repeated-queries.json"
...
Teach `choose_hash_or_sort_for_query_volume` as the primary diagnostic target for `single_pass_vs_repeated_queries` in `contrast_hash_map_vs_sorting`.
