...
futureCanonicalSourcePath: "manual/source/algorithms/intervals/detect-overlap.json"
...
Teach `evaluate_interval_overlap` as the primary diagnostic target for `detect_overlap` in `intervals`.
