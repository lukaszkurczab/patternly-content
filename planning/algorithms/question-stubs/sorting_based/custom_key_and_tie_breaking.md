...
futureCanonicalSourcePath: "manual/source/algorithms/sorting-based/custom-key-and-tie-breaking.json"
...
Teach `define_total_sort_order` as the primary diagnostic target for `custom_key_and_tie_breaking` in `sorting_based`.
