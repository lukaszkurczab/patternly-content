...
unitKind: "direct"
unitId: "recognize_graph_traversal_signal"
contentOwnership: "direct"
primaryPatternFamilyId: "graph_traversal"
legalPatternFamilyIds:
  - "graph_traversal"
primarySkillAtomId: "identify_connected_state_search"
...
futureCanonicalSourcePath: "manual/source/algorithms/graph-traversal/recognize-graph-traversal-signal.json"
...
Teach `identify_connected_state_search` as the primary diagnostic target for `recognize_graph_traversal_signal` in `graph_traversal`.
