...
futureCanonicalSourcePath: "manual/source/algorithms/backtracking/constraint-pruning.json"
...
Teach `prune_impossible_partial_solution` as the primary diagnostic target for `constraint_pruning` in `backtracking`.
