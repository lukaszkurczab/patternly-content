...
futureCanonicalSourcePath: "manual/source/algorithms/sorting-based/sort-then-scan.json"
...
Teach `exploit_adjacent_order_after_sort` as the primary diagnostic target for `sort_then_scan` in `sorting_based`.
