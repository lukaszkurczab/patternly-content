...
futureCanonicalSourcePath: "manual/source/algorithms/dynamic-programming-intro/one-dimensional-dp.json"
...
Teach `model_one_dimensional_dp` as the primary diagnostic target for `one_dimensional_dp` in `dynamic_programming_intro`.
