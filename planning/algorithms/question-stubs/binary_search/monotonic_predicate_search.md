...
unitKind: "direct"
unitId: "monotonic_predicate_search"
contentOwnership: "direct"
primaryPatternFamilyId: "binary_search"
legalPatternFamilyIds:
  - "binary_search"
primarySkillAtomId: "identify_monotonic_predicate"
...
futureCanonicalSourcePath: "manual/source/algorithms/binary-search/monotonic-predicate-search.json"
...
Teach `identify_monotonic_predicate` as the primary diagnostic target for `monotonic_predicate_search` in `binary_search`.
