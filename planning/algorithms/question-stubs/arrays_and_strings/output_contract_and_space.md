...
unitKind: "direct"
unitId: "output_contract_and_space"
contentOwnership: "direct"
primaryPatternFamilyId: "arrays_and_strings"
legalPatternFamilyIds:
  - "arrays_and_strings"
primarySkillAtomId: "distinguish_output_from_auxiliary_space"
...
futureCanonicalSourcePath: "manual/source/algorithms/arrays-and-strings/output-contract-and-space.json"
...
Teach `distinguish_output_from_auxiliary_space` as the primary diagnostic target for `output_contract_and_space` in `arrays_and_strings`.
