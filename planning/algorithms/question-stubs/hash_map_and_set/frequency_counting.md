...
futureCanonicalSourcePath: "manual/source/algorithms/hash-map-and-set/frequency-counting.json"
...
Teach `maintain_frequency_map` as the primary diagnostic target for `frequency_counting` in `hash_map_and_set`.
