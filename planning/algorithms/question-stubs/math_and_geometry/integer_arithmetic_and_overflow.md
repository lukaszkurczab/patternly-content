...
unitKind: "direct"
unitId: "integer_arithmetic_and_overflow"
contentOwnership: "direct"
primaryPatternFamilyId: "math_and_geometry"
legalPatternFamilyIds:
  - "math_and_geometry"
primarySkillAtomId: "avoid_integer_overflow_in_computation"
...
futureCanonicalSourcePath: "manual/source/algorithms/math-and-geometry/integer-arithmetic-and-overflow.json"
...
Teach `avoid_integer_overflow_in_computation` as the primary diagnostic target for `integer_arithmetic_and_overflow` in `math_and_geometry`.
