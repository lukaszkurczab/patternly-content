...
unitKind: "direct"
unitId: "sort_then_two_pointers"
contentOwnership: "direct"
primaryPatternFamilyId: "sorting_based"
legalPatternFamilyIds:
  - "sorting_based"
primarySkillAtomId: "combine_sorting_with_pointer_search"
...
futureCanonicalSourcePath: "manual/source/algorithms/sorting-based/sort-then-two-pointers.json"
...
Teach `combine_sorting_with_pointer_search` as the primary diagnostic target for `sort_then_two_pointers` in `sorting_based`.
