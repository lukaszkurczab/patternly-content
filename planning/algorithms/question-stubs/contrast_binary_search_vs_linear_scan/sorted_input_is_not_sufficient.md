...
unitKind: "contrast"
unitId: "sorted_input_is_not_sufficient"
contentOwnership: "cross_family"
primaryPatternFamilyId: "binary_search"
legalPatternFamilyIds:
  - "binary_search"
  - "arrays_and_strings"
primarySkillAtomId: "reject_sorted_input_alone_as_binary_search_proof"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-binary-search-vs-linear-scan/sorted-input-is-not-sufficient.json"
...
Teach `reject_sorted_input_alone_as_binary_search_proof` as the primary diagnostic target for `sorted_input_is_not_sufficient` in `contrast_binary_search_vs_linear_scan`.
