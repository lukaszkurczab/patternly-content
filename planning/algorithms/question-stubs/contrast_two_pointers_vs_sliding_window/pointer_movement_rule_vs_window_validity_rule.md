...
unitKind: "contrast"
unitId: "pointer_movement_rule_vs_window_validity_rule"
contentOwnership: "cross_family"
primaryPatternFamilyId: "two_pointers"
legalPatternFamilyIds:
  - "two_pointers"
  - "sliding_window"
primarySkillAtomId: "compare_pointer_move_and_window_validity_invariants"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-two-pointers-vs-sliding-window/pointer-movement-rule-vs-window-validity-rule.json"
...
Teach `compare_pointer_move_and_window_validity_invariants` as the primary diagnostic target for `pointer_movement_rule_vs_window_validity_rule` in `contrast_two_pointers_vs_sliding_window`.
