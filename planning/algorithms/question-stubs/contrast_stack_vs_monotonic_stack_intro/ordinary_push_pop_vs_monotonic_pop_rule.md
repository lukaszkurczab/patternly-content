...
unitKind: "contrast"
unitId: "ordinary_push_pop_vs_monotonic_pop_rule"
contentOwnership: "cross_family"
primaryPatternFamilyId: "stack"
legalPatternFamilyIds:
  - "stack"
  - "monotonic_stack"
primarySkillAtomId: "compare_stack_pop_rules"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-stack-vs-monotonic-stack-intro/ordinary-push-pop-vs-monotonic-pop-rule.json"
...
Teach `compare_stack_pop_rules` as the primary diagnostic target for `ordinary_push_pop_vs_monotonic_pop_rule` in `contrast_stack_vs_monotonic_stack_intro`.
