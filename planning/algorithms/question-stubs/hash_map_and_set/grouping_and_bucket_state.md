...
futureCanonicalSourcePath: "manual/source/algorithms/hash-map-and-set/grouping-and-bucket-state.json"
...
Teach `choose_grouping_key` as the primary diagnostic target for `grouping_and_bucket_state` in `hash_map_and_set`.
