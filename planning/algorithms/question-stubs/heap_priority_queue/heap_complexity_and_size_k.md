...
futureCanonicalSourcePath: "manual/source/algorithms/heap-priority-queue/heap-complexity-and-size-k.json"
...
Teach `derive_heap_cost_from_heap_size` as the primary diagnostic target for `heap_complexity_and_size_k` in `heap_priority_queue`.
