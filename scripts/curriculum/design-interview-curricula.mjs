...
const DESIGN_TRUST_ROOT_SHA256 = "fefb8ebce96e47fc53f30dff19cf5ca5b234f175a23388ab09ac5b107dd31a27";
const DESIGN_FAMILY_CONTRACT_SHA256 = "22cc00503cf43ddb4b89ecf2a4607de962352eb76542e4e666d58c88cd8217d3";
...
const EXPECTED_RESOLVED_BY_TRACK = Object.freeze({
  "backend-system-design-interview": 73,
...
function assertRegistry(value = registry, { repositoryRoot: root = repositoryRoot } = {}) {
  ...
  if (value.sourceRecords.length !== 118 || value.sourceCaptures.length !== 76 || value.anchorRecords.length !== 329 || value.claims.length !== 231 || value.slotBindings.length !== 254) fail("INVALID_DESIGN_SOURCE_REGISTRY_TOTAL", "frozen derived totals");
