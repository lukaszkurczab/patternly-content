...
roadmapNodeId: "stack"
unitKind: "direct"
unitId: "recognize_monotonic_stack_signal"
contentOwnership: "direct"
primaryPatternFamilyId: "monotonic_stack"
legalPatternFamilyIds:
  - "monotonic_stack"
primarySkillAtomId: "identify_dominated_candidate_signal"
...
futureCanonicalSourcePath: "manual/source/algorithms/stack/recognize-monotonic-stack-signal.json"
...
Teach `identify_dominated_candidate_signal` as the primary diagnostic target for `recognize_monotonic_stack_signal` in `stack`.
...
- The selected family boundary: `monotonic_stack`.
