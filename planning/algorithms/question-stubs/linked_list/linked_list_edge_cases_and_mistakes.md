...
unitKind: "direct"
unitId: "linked_list_edge_cases_and_mistakes"
contentOwnership: "direct"
primaryPatternFamilyId: "linked_list"
legalPatternFamilyIds:
  - "linked_list"
primarySkillAtomId: "diagnose_linked_list_rewiring_error"
...
futureCanonicalSourcePath: "manual/source/algorithms/linked-list/linked-list-edge-cases-and-mistakes.json"
...
Teach `diagnose_linked_list_rewiring_error` as the primary diagnostic target for `linked_list_edge_cases_and_mistakes` in `linked_list`.
