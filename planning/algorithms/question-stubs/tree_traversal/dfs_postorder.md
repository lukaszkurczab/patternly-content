...
futureCanonicalSourcePath: "manual/source/algorithms/tree-traversal/dfs-postorder.json"
...
Teach `apply_postorder_processing` as the primary diagnostic target for `dfs_postorder` in `tree_traversal`.
