...
futureCanonicalSourcePath: "manual/source/algorithms/math-and-geometry/modular-arithmetic.json"
...
Teach `preserve_modular_equivalence` as the primary diagnostic target for `modular_arithmetic` in `math_and_geometry`.
