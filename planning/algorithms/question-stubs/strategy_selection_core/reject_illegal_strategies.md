...
unitKind: "strategy"
unitId: "reject_illegal_strategies"
...
legalPatternFamilyIds:
  ...
  - "monotonic_stack"
  - "binary_search"
primarySkillAtomId: "reject_strategy_without_required_invariant"
...
futureCanonicalSourcePath: "manual/source/algorithms/strategy-selection-core/reject-illegal-strategies.json"
...
Teach `reject_strategy_without_required_invariant` as the primary diagnostic target for `reject_illegal_strategies` in `strategy_selection_core`.
