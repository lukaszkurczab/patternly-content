...
futureCanonicalSourcePath: "manual/source/algorithms/bit-manipulation/count-bits-and-lowest-set-bit.json"
...
Teach `remove_lowest_set_bit` as the primary diagnostic target for `count_bits_and_lowest_set_bit` in `bit_manipulation`.
