...
unitKind: "contrast"
unitId: "expected_linear_vs_n_log_n_cost"
contentOwnership: "cross_family"
primaryPatternFamilyId: "hash_map_and_set"
legalPatternFamilyIds:
  - "hash_map_and_set"
  - "sorting_based"
primarySkillAtomId: "compare_expected_hash_and_sorting_cost"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-hash-map-vs-sorting/expected-linear-vs-n-log-n-cost.json"
...
Teach `compare_expected_hash_and_sorting_cost` as the primary diagnostic target for `expected_linear_vs_n_log_n_cost` in `contrast_hash_map_vs_sorting`.
