...
futureCanonicalSourcePath: "manual/source/algorithms/greedy-intro/define-local-choice.json"
...
Teach `define_local_optimization_rule` as the primary diagnostic target for `define_local_choice` in `greedy_intro`.
