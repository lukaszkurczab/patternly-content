# Coding Interview taxonomy rationale
...
## Identity cutover record

This rationale moved with the atomic `TRACK-01` cutover from the retired
Algorithms planning ledger to the canonical Coding Interview content owner.
The taxonomy IDs, item IDs, option IDs, and technical-evidence identities are
preserved. PO-058 authorizes the eight reviewed two-pointers sources for this
canonical namespace; it does not authorize changed question payloads.
