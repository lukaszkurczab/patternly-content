...
futureCanonicalSourcePath: "manual/source/algorithms/greedy-intro/prove-safe-choice.json"
...
Teach `justify_greedy_choice_safety` as the primary diagnostic target for `prove_safe_choice` in `greedy_intro`.
