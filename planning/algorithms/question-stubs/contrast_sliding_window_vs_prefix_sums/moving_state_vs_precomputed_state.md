...
unitKind: "contrast"
unitId: "moving_state_vs_precomputed_state"
contentOwnership: "cross_family"
primaryPatternFamilyId: "sliding_window"
legalPatternFamilyIds:
  - "sliding_window"
  - "prefix_sums"
primarySkillAtomId: "distinguish_moving_window_from_precomputed_prefix"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-sliding-window-vs-prefix-sums/moving-state-vs-precomputed-state.json"
...
Teach `distinguish_moving_window_from_precomputed_prefix` as the primary diagnostic target for `moving_state_vs_precomputed_state` in `contrast_sliding_window_vs_prefix_sums`.
