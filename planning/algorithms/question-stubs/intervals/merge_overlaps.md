...
futureCanonicalSourcePath: "manual/source/algorithms/intervals/merge-overlaps.json"
...
Teach `merge_overlapping_intervals` as the primary diagnostic target for `merge_overlaps` in `intervals`.
