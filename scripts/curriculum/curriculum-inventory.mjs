...
export async function buildExistingContentInventories({ root = ROOT, outputDirectory = join(root, "evidence", "curriculum", "2026.08.09") } = {}) {
  ...
  if (codingItems.length !== coding.existingVerifiedItemCount) throw new Error(`CODING_INVENTORY_COUNT_MISMATCH: expected ${coding.existingVerifiedItemCount} verified items, found ${codingItems.length}.`);
