...
unitKind: "contrast"
unitId: "correctness_before_asymptotic_speed"
contentOwnership: "cross_family"
primaryPatternFamilyId: "binary_search"
legalPatternFamilyIds:
  - "binary_search"
  - "arrays_and_strings"
primarySkillAtomId: "prioritize_correctness_in_binary_vs_scan_choice"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-binary-search-vs-linear-scan/correctness-before-asymptotic-speed.json"
...
Teach `prioritize_correctness_in_binary_vs_scan_choice` as the primary diagnostic target for `correctness_before_asymptotic_speed` in `contrast_binary_search_vs_linear_scan`.
