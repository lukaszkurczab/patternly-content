...
unitKind: "contrast"
unitId: "negative_values_break_simple_window"
contentOwnership: "cross_family"
primaryPatternFamilyId: "sliding_window"
legalPatternFamilyIds:
  - "sliding_window"
  - "prefix_sums"
primarySkillAtomId: "detect_negative_value_window_failure"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-sliding-window-vs-prefix-sums/negative-values-break-simple-window.json"
...
Teach `detect_negative_value_window_failure` as the primary diagnostic target for `negative_values_break_simple_window` in `contrast_sliding_window_vs_prefix_sums`.
