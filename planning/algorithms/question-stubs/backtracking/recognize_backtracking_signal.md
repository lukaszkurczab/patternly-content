...
unitKind: "direct"
unitId: "recognize_backtracking_signal"
contentOwnership: "direct"
primaryPatternFamilyId: "backtracking"
legalPatternFamilyIds:
  - "backtracking"
primarySkillAtomId: "identify_choice_tree_search"
...
futureCanonicalSourcePath: "manual/source/algorithms/backtracking/recognize-backtracking-signal.json"
...
Teach `identify_choice_tree_search` as the primary diagnostic target for `recognize_backtracking_signal` in `backtracking`.
