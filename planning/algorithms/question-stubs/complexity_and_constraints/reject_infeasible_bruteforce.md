...
futureCanonicalSourcePath: "manual/source/algorithms/complexity-and-constraints/reject-infeasible-bruteforce.json"
...
Teach `reject_infeasible_complexity` as the primary diagnostic target for `reject_infeasible_bruteforce` in `complexity_and_constraints`.
