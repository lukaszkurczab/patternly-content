...
unitKind: "strategy"
unitId: "choose_for_single_vs_repeated_queries"
...
legalPatternFamilyIds:
  ...
  - "monotonic_stack"
  - "binary_search"
primarySkillAtomId: "choose_strategy_for_query_volume"
...
futureCanonicalSourcePath: "manual/source/algorithms/strategy-selection-core/choose-for-single-vs-repeated-queries.json"
...
Teach `choose_strategy_for_query_volume` as the primary diagnostic target for `choose_for_single_vs_repeated_queries` in `strategy_selection_core`.
