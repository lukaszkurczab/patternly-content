...
futureCanonicalSourcePath: "manual/source/algorithms/graph-traversal/connected-components.json"
...
Teach `count_connected_components` as the primary diagnostic target for `connected_components` in `graph_traversal`.
