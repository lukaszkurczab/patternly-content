...
unitKind: "contrast"
unitId: "single_query_cost_comparison"
contentOwnership: "cross_family"
primaryPatternFamilyId: "binary_search"
legalPatternFamilyIds:
  - "binary_search"
  - "arrays_and_strings"
primarySkillAtomId: "compare_single_query_binary_and_linear_cost"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-binary-search-vs-linear-scan/single-query-cost-comparison.json"
...
Teach `compare_single_query_binary_and_linear_cost` as the primary diagnostic target for `single_query_cost_comparison` in `contrast_binary_search_vs_linear_scan`.
