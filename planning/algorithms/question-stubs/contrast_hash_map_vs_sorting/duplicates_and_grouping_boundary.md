...
unitKind: "contrast"
unitId: "duplicates_and_grouping_boundary"
contentOwnership: "cross_family"
primaryPatternFamilyId: "hash_map_and_set"
legalPatternFamilyIds:
  - "hash_map_and_set"
  - "sorting_based"
primarySkillAtomId: "choose_hash_or_sort_for_duplicates_and_grouping"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-hash-map-vs-sorting/duplicates-and-grouping-boundary.json"
...
Teach `choose_hash_or_sort_for_duplicates_and_grouping` as the primary diagnostic target for `duplicates_and_grouping_boundary` in `contrast_hash_map_vs_sorting`.
