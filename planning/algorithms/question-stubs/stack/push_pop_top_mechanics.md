...
futureCanonicalSourcePath: "manual/source/algorithms/stack/push-pop-top-mechanics.json"
...
Teach `trace_stack_operation` as the primary diagnostic target for `push_pop_top_mechanics` in `stack`.
