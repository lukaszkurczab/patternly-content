...
futureCanonicalSourcePath: "manual/source/algorithms/complexity-and-constraints/preprocessing-and-query-tradeoffs.json"
...
Teach `compare_preprocessing_and_query_cost` as the primary diagnostic target for `preprocessing_and_query_tradeoffs` in `complexity_and_constraints`.
