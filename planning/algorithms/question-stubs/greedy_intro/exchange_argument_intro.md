...
unitKind: "direct"
unitId: "exchange_argument_intro"
contentOwnership: "direct"
primaryPatternFamilyId: "greedy_intro"
legalPatternFamilyIds:
  - "greedy_intro"
primarySkillAtomId: "construct_basic_exchange_argument"
...
futureCanonicalSourcePath: "manual/source/algorithms/greedy-intro/exchange-argument-intro.json"
...
Teach `construct_basic_exchange_argument` as the primary diagnostic target for `exchange_argument_intro` in `greedy_intro`.
