...
futureCanonicalSourcePath: "manual/source/algorithms/dynamic-programming-intro/reconstruct-solution-intro.json"
...
Teach `reconstruct_choice_from_dp_state` as the primary diagnostic target for `reconstruct_solution_intro` in `dynamic_programming_intro`.
