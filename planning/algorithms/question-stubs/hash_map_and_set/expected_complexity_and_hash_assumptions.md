...
unitKind: "direct"
unitId: "expected_complexity_and_hash_assumptions"
contentOwnership: "direct"
primaryPatternFamilyId: "hash_map_and_set"
legalPatternFamilyIds:
  - "hash_map_and_set"
primarySkillAtomId: "explain_expected_hash_lookup_complexity"
...
futureCanonicalSourcePath: "manual/source/algorithms/hash-map-and-set/expected-complexity-and-hash-assumptions.json"
...
Teach `explain_expected_hash_lookup_complexity` as the primary diagnostic target for `expected_complexity_and_hash_assumptions` in `hash_map_and_set`.
