...
unitKind: "contrast"
unitId: "sorted_input_vs_contiguity"
contentOwnership: "cross_family"
primaryPatternFamilyId: "two_pointers"
legalPatternFamilyIds:
  - "two_pointers"
  - "sliding_window"
primarySkillAtomId: "distinguish_sorted_input_signal_from_contiguity_signal"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-two-pointers-vs-sliding-window/sorted-input-vs-contiguity.json"
...
Teach `distinguish_sorted_input_signal_from_contiguity_signal` as the primary diagnostic target for `sorted_input_vs_contiguity` in `contrast_two_pointers_vs_sliding_window`.
