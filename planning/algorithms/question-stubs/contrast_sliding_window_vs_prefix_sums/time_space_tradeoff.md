...
unitKind: "contrast"
unitId: "time_space_tradeoff"
contentOwnership: "cross_family"
primaryPatternFamilyId: "sliding_window"
legalPatternFamilyIds:
  - "sliding_window"
  - "prefix_sums"
primarySkillAtomId: "compare_window_and_prefix_time_space_tradeoff"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-sliding-window-vs-prefix-sums/time-space-tradeoff.json"
...
Teach `compare_window_and_prefix_time_space_tradeoff` as the primary diagnostic target for `time_space_tradeoff` in `contrast_sliding_window_vs_prefix_sums`.
