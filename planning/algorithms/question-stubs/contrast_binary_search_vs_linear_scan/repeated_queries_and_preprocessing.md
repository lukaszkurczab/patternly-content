...
unitKind: "contrast"
unitId: "repeated_queries_and_preprocessing"
contentOwnership: "cross_family"
primaryPatternFamilyId: "binary_search"
legalPatternFamilyIds:
  - "binary_search"
  - "arrays_and_strings"
primarySkillAtomId: "compare_preprocessing_and_repeated_query_cost"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-binary-search-vs-linear-scan/repeated-queries-and-preprocessing.json"
...
Teach `compare_preprocessing_and_repeated_query_cost` as the primary diagnostic target for `repeated_queries_and_preprocessing` in `contrast_binary_search_vs_linear_scan`.
