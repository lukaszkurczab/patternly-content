...
unitKind: "direct"
unitId: "recognize_repeated_extreme_signal"
contentOwnership: "direct"
primaryPatternFamilyId: "heap_priority_queue"
legalPatternFamilyIds:
  - "heap_priority_queue"
primarySkillAtomId: "identify_repeated_extreme_requirement"
...
futureCanonicalSourcePath: "manual/source/algorithms/heap-priority-queue/recognize-repeated-extreme-signal.json"
...
Teach `identify_repeated_extreme_requirement` as the primary diagnostic target for `recognize_repeated_extreme_signal` in `heap_priority_queue`.
