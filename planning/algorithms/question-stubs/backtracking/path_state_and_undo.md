...
futureCanonicalSourcePath: "manual/source/algorithms/backtracking/path-state-and-undo.json"
...
Teach `restore_path_state_after_branch` as the primary diagnostic target for `path_state_and_undo` in `backtracking`.
