...
unitKind: "contrast"
unitId: "preservation_of_order_and_indices"
contentOwnership: "cross_family"
primaryPatternFamilyId: "hash_map_and_set"
legalPatternFamilyIds:
  - "hash_map_and_set"
  - "sorting_based"
primarySkillAtomId: "preserve_order_and_indices_across_strategy_choice"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-hash-map-vs-sorting/preservation-of-order-and-indices.json"
...
Teach `preserve_order_and_indices_across_strategy_choice` as the primary diagnostic target for `preservation_of_order_and_indices` in `contrast_hash_map_vs_sorting`.
