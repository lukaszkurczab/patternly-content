...
unitKind: "direct"
unitId: "variable_size_monotonic_window"
contentOwnership: "direct"
primaryPatternFamilyId: "sliding_window"
legalPatternFamilyIds:
  - "sliding_window"
primarySkillAtomId: "maintain_monotonic_shrink_rule"
...
futureCanonicalSourcePath: "manual/source/algorithms/sliding-window/variable-size-monotonic-window.json"
...
Teach `maintain_monotonic_shrink_rule` as the primary diagnostic target for `variable_size_monotonic_window` in `sliding_window`.
