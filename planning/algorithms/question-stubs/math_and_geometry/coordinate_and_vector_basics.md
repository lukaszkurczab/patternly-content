...
unitKind: "direct"
unitId: "coordinate_and_vector_basics"
contentOwnership: "direct"
primaryPatternFamilyId: "math_and_geometry"
legalPatternFamilyIds:
  - "math_and_geometry"
primarySkillAtomId: "represent_geometric_relation_with_vectors"
...
futureCanonicalSourcePath: "manual/source/algorithms/math-and-geometry/coordinate-and-vector-basics.json"
...
Teach `represent_geometric_relation_with_vectors` as the primary diagnostic target for `coordinate_and_vector_basics` in `math_and_geometry`.
