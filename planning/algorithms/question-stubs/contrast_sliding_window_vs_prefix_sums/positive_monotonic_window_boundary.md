...
unitKind: "contrast"
unitId: "positive_monotonic_window_boundary"
contentOwnership: "cross_family"
primaryPatternFamilyId: "sliding_window"
legalPatternFamilyIds:
  - "sliding_window"
  - "prefix_sums"
primarySkillAtomId: "identify_positive_monotonic_window_boundary"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-sliding-window-vs-prefix-sums/positive-monotonic-window-boundary.json"
...
Teach `identify_positive_monotonic_window_boundary` as the primary diagnostic target for `positive_monotonic_window_boundary` in `contrast_sliding_window_vs_prefix_sums`.
