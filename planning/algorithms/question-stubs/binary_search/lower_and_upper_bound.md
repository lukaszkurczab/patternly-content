...
unitKind: "direct"
unitId: "lower_and_upper_bound"
contentOwnership: "direct"
primaryPatternFamilyId: "binary_search"
legalPatternFamilyIds:
  - "binary_search"
primarySkillAtomId: "find_first_or_last_valid_boundary"
...
futureCanonicalSourcePath: "manual/source/algorithms/binary-search/lower-and-upper-bound.json"
...
Teach `find_first_or_last_valid_boundary` as the primary diagnostic target for `lower_and_upper_bound` in `binary_search`.
