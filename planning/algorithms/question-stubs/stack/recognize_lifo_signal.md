...
roadmapNodeId: "stack"
unitKind: "direct"
unitId: "recognize_lifo_signal"
contentOwnership: "direct"
primaryPatternFamilyId: "stack"
legalPatternFamilyIds:
  - "stack"
primarySkillAtomId: "identify_last_unresolved_state"
...
futureCanonicalSourcePath: "manual/source/algorithms/stack/recognize-lifo-signal.json"
...
Teach `identify_last_unresolved_state` as the primary diagnostic target for `recognize_lifo_signal` in `stack`.
