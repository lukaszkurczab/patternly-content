...
futureCanonicalSourcePath: "manual/source/algorithms/binary-search/binary-search-on-answer.json"
...
Teach `search_feasible_answer_space` as the primary diagnostic target for `binary_search_on_answer` in `binary_search`.
