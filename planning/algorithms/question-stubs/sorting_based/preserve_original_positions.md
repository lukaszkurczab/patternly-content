...
unitKind: "direct"
unitId: "preserve_original_positions"
contentOwnership: "direct"
primaryPatternFamilyId: "sorting_based"
legalPatternFamilyIds:
  - "sorting_based"
primarySkillAtomId: "preserve_original_identity_through_sorting"
...
futureCanonicalSourcePath: "manual/source/algorithms/sorting-based/preserve-original-positions.json"
...
Teach `preserve_original_identity_through_sorting` as the primary diagnostic target for `preserve_original_positions` in `sorting_based`.
