...
unitKind: "direct"
unitId: "distance_and_slope_without_precision_loss"
contentOwnership: "direct"
primaryPatternFamilyId: "math_and_geometry"
legalPatternFamilyIds:
  - "math_and_geometry"
primarySkillAtomId: "compare_geometric_quantities_without_unsafe_division"
...
futureCanonicalSourcePath: "manual/source/algorithms/math-and-geometry/distance-and-slope-without-precision-loss.json"
...
Teach `compare_geometric_quantities_without_unsafe_division` as the primary diagnostic target for `distance_and_slope_without_precision_loss` in `math_and_geometry`.
