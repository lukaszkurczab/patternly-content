...
futureCanonicalSourcePath: "manual/source/algorithms/complexity-and-constraints/derive-time-complexity.json"
...
Teach `derive_time_complexity` as the primary diagnostic target for `derive_time_complexity` in `complexity_and_constraints`.
