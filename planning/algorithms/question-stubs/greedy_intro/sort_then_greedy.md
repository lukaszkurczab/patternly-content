...
futureCanonicalSourcePath: "manual/source/algorithms/greedy-intro/sort-then-greedy.json"
...
Teach `choose_sort_key_for_greedy_process` as the primary diagnostic target for `sort_then_greedy` in `greedy_intro`.
