...
futureCanonicalSourcePath: "manual/source/algorithms/hash-map-and-set/hash-state-mistake-review.json"
...
Teach `diagnose_hash_state_mismatch` as the primary diagnostic target for `hash_state_mistake_review` in `hash_map_and_set`.
