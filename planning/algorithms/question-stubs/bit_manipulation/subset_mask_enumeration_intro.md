...
futureCanonicalSourcePath: "manual/source/algorithms/bit-manipulation/subset-mask-enumeration-intro.json"
...
Teach `enumerate_subset_by_bitmask` as the primary diagnostic target for `subset_mask_enumeration_intro` in `bit_manipulation`.
