...
futureCanonicalSourcePath: "manual/source/algorithms/recursion-basics/choose-recursive-state.json"
...
Teach `choose_minimal_recursive_state` as the primary diagnostic target for `choose_recursive_state` in `recursion_basics`.
