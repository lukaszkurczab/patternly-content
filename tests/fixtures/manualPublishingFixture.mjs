...
export async function fixtureRoot(root, { algorithms, certification, approvals = true, legacy = false } = {}) {
  ...
  await write(root, "config/families/certification.json", { schemaVersion: "family-config-v1", familyId: "certification", supportedInteractions: ["choice"], modes: [{ id: "certification-diagnostic-baseline", minimumPool: 40 }, { id: "certification-focus-practice", minimumPool: 10 }, { id: "certification-scenario-practice", minimumPool: 10 }, { id: "certification-weak-area-review", minimumPool: 1 }, { id: "certification-mixed-practice", minimumPool: 10 }, { id: "cloud-practice", minimumPool: 10 }] });
