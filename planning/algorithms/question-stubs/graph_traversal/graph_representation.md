...
futureCanonicalSourcePath: "manual/source/algorithms/graph-traversal/graph-representation.json"
...
Teach `choose_graph_representation` as the primary diagnostic target for `graph_representation` in `graph_traversal`.
