...
unitKind: "strategy"
unitId: "transfer_to_unfamiliar_problem"
...
legalPatternFamilyIds:
  ...
  - "monotonic_stack"
  - "binary_search"
primarySkillAtomId: "transfer_strategy_selection_to_new_surface_form"
...
futureCanonicalSourcePath: "manual/source/algorithms/strategy-selection-core/transfer-to-unfamiliar-problem.json"
...
Teach `transfer_strategy_selection_to_new_surface_form` as the primary diagnostic target for `transfer_to_unfamiliar_problem` in `strategy_selection_core`.
