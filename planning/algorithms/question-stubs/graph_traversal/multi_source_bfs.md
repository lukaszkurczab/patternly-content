...
futureCanonicalSourcePath: "manual/source/algorithms/graph-traversal/multi-source-bfs.json"
...
Teach `initialize_multi_source_frontier` as the primary diagnostic target for `multi_source_bfs` in `graph_traversal`.
