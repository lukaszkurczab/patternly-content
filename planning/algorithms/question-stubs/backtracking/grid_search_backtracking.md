...
unitKind: "direct"
unitId: "grid_search_backtracking"
contentOwnership: "direct"
primaryPatternFamilyId: "backtracking"
legalPatternFamilyIds:
  - "backtracking"
primarySkillAtomId: "maintain_grid_search_visited_state"
...
futureCanonicalSourcePath: "manual/source/algorithms/backtracking/grid-search-backtracking.json"
...
Teach `maintain_grid_search_visited_state` as the primary diagnostic target for `grid_search_backtracking` in `backtracking`.
