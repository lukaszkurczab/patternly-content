...
unitKind: "contrast"
unitId: "pair_relation_vs_contiguous_range"
contentOwnership: "cross_family"
primaryPatternFamilyId: "two_pointers"
legalPatternFamilyIds:
  - "two_pointers"
  - "sliding_window"
primarySkillAtomId: "distinguish_pair_relation_from_contiguous_window"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-two-pointers-vs-sliding-window/pair-relation-vs-contiguous-range.json"
...
Teach `distinguish_pair_relation_from_contiguous_window` as the primary diagnostic target for `pair_relation_vs_contiguous_range` in `contrast_two_pointers_vs_sliding_window`.
