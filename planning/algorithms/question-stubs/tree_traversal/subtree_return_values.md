...
unitKind: "direct"
unitId: "subtree_return_values"
contentOwnership: "direct"
primaryPatternFamilyId: "tree_traversal"
legalPatternFamilyIds:
  - "tree_traversal"
primarySkillAtomId: "derive_parent_result_from_subtrees"
...
futureCanonicalSourcePath: "manual/source/algorithms/tree-traversal/subtree-return-values.json"
...
Teach `derive_parent_result_from_subtrees` as the primary diagnostic target for `subtree_return_values` in `tree_traversal`.
