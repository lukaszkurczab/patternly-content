...
unitKind: "direct"
unitId: "fast_and_slow_pointers"
contentOwnership: "direct"
primaryPatternFamilyId: "linked_list"
legalPatternFamilyIds:
  - "linked_list"
primarySkillAtomId: "maintain_relative_pointer_speed"
...
futureCanonicalSourcePath: "manual/source/algorithms/linked-list/fast-and-slow-pointers.json"
...
Teach `maintain_relative_pointer_speed` as the primary diagnostic target for `fast_and_slow_pointers` in `linked_list`.
