...
futureCanonicalSourcePath: "manual/source/algorithms/complexity-and-constraints/output-sensitive-and-lower-bounds.json"
...
Teach `recognize_output_sensitive_lower_bound` as the primary diagnostic target for `output_sensitive_and_lower_bounds` in `complexity_and_constraints`.
