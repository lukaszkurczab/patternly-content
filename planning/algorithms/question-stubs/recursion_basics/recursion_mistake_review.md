...
unitKind: "direct"
unitId: "recursion_mistake_review"
contentOwnership: "direct"
primaryPatternFamilyId: "recursion_basics"
legalPatternFamilyIds:
  - "recursion_basics"
primarySkillAtomId: "diagnose_nonterminating_or_incomplete_recursion"
...
futureCanonicalSourcePath: "manual/source/algorithms/recursion-basics/recursion-mistake-review.json"
...
Teach `diagnose_nonterminating_or_incomplete_recursion` as the primary diagnostic target for `recursion_mistake_review` in `recursion_basics`.
