...
futureCanonicalSourcePath: "manual/source/algorithms/graph-traversal/topological-order-intro.json"
...
Teach `process_dependency_order` as the primary diagnostic target for `topological_order_intro` in `graph_traversal`.
