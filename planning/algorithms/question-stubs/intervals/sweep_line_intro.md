...
futureCanonicalSourcePath: "manual/source/algorithms/intervals/sweep-line-intro.json"
...
Teach `process_interval_events_in_order` as the primary diagnostic target for `sweep_line_intro` in `intervals`.
