...
legalPatternFamilyIds:
  - "graph_traversal"
primarySkillAtomId: "traverse_graph_depth_first"
...
futureCanonicalSourcePath: "manual/source/algorithms/graph-traversal/graph-dfs.json"
...
Teach `traverse_graph_depth_first` as the primary diagnostic target for `graph_dfs` in `graph_traversal`.
