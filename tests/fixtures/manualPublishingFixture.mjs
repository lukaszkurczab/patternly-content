...
const fixtureModeConfiguration = {
  ...
  simulationBlueprint: { blueprintId: "fixture-interview-simulation", blueprintVersion: "1", modeId: "coding-interview-simulation", profileId: "algorithms-interview-simulation-v1", profileVersion: "1", requestedLength: 40, actualLength: 40, shorteningPolicy: "prohibited", uniqueItemsRequired: 40, timerKind: "foreground_countdown", durationMinutes: 45, navigationPolicy: "free_navigation", answerChangePolicy: "editable_until_finalization", reinsertPolicy: "disabled", feedbackTiming: "after_verified_finalization", learningStages: ["simulation"], selectionPolicy: { requireUniqueItemIds: true, requireDeclaredSimulationEligibility: true, requireMultipleMentalUnits: true, requireMultiplePatternFamilies: true, requireEveryActiveInteractionTypeRepresented: true, prohibitConsecutiveSameMentalUnitWhenAlternativeExists: true, prohibitDuplicateContentIdentity: true, prohibitTaxonomyWidening: true, prohibitFallbackItems: true } },
  userModeMappings: [
    { userModeId: "coding-interview-learn-approach", blueprintModeId: "coding-interview-learn-approach" }, { userModeId: "coding-interview-guided-practice", blueprintModeId: "coding-interview-guided-practice" }, { userModeId: "coding-interview-custom-practice", blueprintModeId: "coding-interview-guided-practice" }, { userModeId: "coding-interview-recognize-patterns", blueprintModeId: "coding-interview-recognize-patterns" }, { userModeId: "coding-interview-contrast-practice", blueprintModeId: "coding-interview-contrast-practice" }, { userModeId: "coding-interview-weak-area-review", blueprintModeId: "coding-interview-weak-area-review" }, { userModeId: "coding-interview-independent-practice", blueprintModeId: "coding-interview-independent-practice" }, { userModeId: "coding-interview-simulation", blueprintModeId: "coding-interview-simulation" },
  ],
};
export function algorithmsBatch({ count = 40, duplicate = false, badTaxonomy = false, invalidChoice = false, declaredModes = ["coding-interview-simulation"], poolIds, profile, modeStructures } = {}) {
