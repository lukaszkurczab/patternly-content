...
unitKind: "direct"
unitId: "greedy_failure_signals"
contentOwnership: "direct"
primaryPatternFamilyId: "greedy_intro"
legalPatternFamilyIds:
  - "greedy_intro"
primarySkillAtomId: "detect_missing_greedy_choice_property"
...
futureCanonicalSourcePath: "manual/source/algorithms/greedy-intro/greedy-failure-signals.json"
...
Teach `detect_missing_greedy_choice_property` as the primary diagnostic target for `greedy_failure_signals` in `greedy_intro`.
