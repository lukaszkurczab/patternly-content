...
unitKind: "strategy"
unitId: "compare_time_space_and_preprocessing"
...
legalPatternFamilyIds:
  ...
  - "monotonic_stack"
  - "binary_search"
primarySkillAtomId: "compare_candidate_cost_models"
...
futureCanonicalSourcePath: "manual/source/algorithms/strategy-selection-core/compare-time-space-and-preprocessing.json"
...
Teach `compare_candidate_cost_models` as the primary diagnostic target for `compare_time_space_and_preprocessing` in `strategy_selection_core`.
