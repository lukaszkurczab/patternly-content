...
unitKind: "direct"
unitId: "sorting_based_mistake_review"
contentOwnership: "direct"
primaryPatternFamilyId: "sorting_based"
legalPatternFamilyIds:
  - "sorting_based"
primarySkillAtomId: "diagnose_invalid_sorting_assumption"
...
futureCanonicalSourcePath: "manual/source/algorithms/sorting-based/sorting-based-mistake-review.json"
...
Teach `diagnose_invalid_sorting_assumption` as the primary diagnostic target for `sorting_based_mistake_review` in `sorting_based`.
