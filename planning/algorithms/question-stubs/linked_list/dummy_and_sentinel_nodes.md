...
unitKind: "direct"
unitId: "dummy_and_sentinel_nodes"
contentOwnership: "direct"
primaryPatternFamilyId: "linked_list"
legalPatternFamilyIds:
  - "linked_list"
primarySkillAtomId: "simplify_head_boundary_with_sentinel"
...
futureCanonicalSourcePath: "manual/source/algorithms/linked-list/dummy-and-sentinel-nodes.json"
...
Teach `simplify_head_boundary_with_sentinel` as the primary diagnostic target for `dummy_and_sentinel_nodes` in `linked_list`.
