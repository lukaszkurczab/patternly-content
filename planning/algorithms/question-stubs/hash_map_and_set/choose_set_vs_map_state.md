...
futureCanonicalSourcePath: "manual/source/algorithms/hash-map-and-set/choose-set-vs-map-state.json"
...
Teach `distinguish_set_from_map_state` as the primary diagnostic target for `choose_set_vs_map_state` in `hash_map_and_set`.
