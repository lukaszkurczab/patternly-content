...
unitKind: "direct"
unitId: "complexity_explanation_and_mistake_review"
contentOwnership: "direct"
primaryPatternFamilyId: "complexity_and_constraints"
legalPatternFamilyIds:
  - "complexity_and_constraints"
primarySkillAtomId: "explain_complexity_from_executed_operations"
secondarySkillAtomIds: []
learningStage: "foundations"
allowedPatternVariantIds: []
allowedProblemArchetypeIds:
  - "analyze_scaling_limit"
  - "compare_solution_costs"
  - "repeated_query_cost_model"
  - "output_sensitive_analysis"
relevantFalseHeuristicIds:
  - "amortized_equals_worst_case"
  - "ignore_output_size"
  - "ignore_preprocessing_cost"
  - "nested_loops_always_quadratic"
  - "variable_names_determine_big_o"
futureBatchKind: "standard"
futureCanonicalSourcePath: "manual/source/algorithms/complexity-and-constraints/complexity-explanation-and-mistake-review.json"
...
Teach `explain_complexity_from_executed_operations` as the primary diagnostic target for `complexity_explanation_and_mistake_review` in `complexity_and_constraints`.
...
- The selected family boundary: `complexity_and_constraints`.
...
- Problem archetypes: `analyze_scaling_limit`, `compare_solution_costs`, `repeated_query_cost_model`, `output_sensitive_analysis`
