...
unitKind: "contrast"
unitId: "prefix_hash_state_boundary"
contentOwnership: "cross_family"
primaryPatternFamilyId: "sliding_window"
legalPatternFamilyIds:
  - "sliding_window"
  - "prefix_sums"
primarySkillAtomId: "identify_prefix_hash_state_requirement"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-sliding-window-vs-prefix-sums/prefix-hash-state-boundary.json"
...
Teach `identify_prefix_hash_state_requirement` as the primary diagnostic target for `prefix_hash_state_boundary` in `contrast_sliding_window_vs_prefix_sums`.
