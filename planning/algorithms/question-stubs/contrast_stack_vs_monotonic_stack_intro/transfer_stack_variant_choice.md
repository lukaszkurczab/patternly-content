...
unitKind: "contrast"
unitId: "transfer_stack_variant_choice"
contentOwnership: "cross_family"
primaryPatternFamilyId: "stack"
legalPatternFamilyIds:
  - "stack"
  - "monotonic_stack"
primarySkillAtomId: "transfer_stack_variant_choice"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-stack-vs-monotonic-stack-intro/transfer-stack-variant-choice.json"
...
Teach `transfer_stack_variant_choice` as the primary diagnostic target for `transfer_stack_variant_choice` in `contrast_stack_vs_monotonic_stack_intro`.
