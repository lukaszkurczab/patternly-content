...
unitKind: "direct"
unitId: "reason_about_indexed_scans"
...
futureCanonicalSourcePath: "manual/source/algorithms/arrays-and-strings/reason-about-indexed-scans.json"
...
Teach `track_index_boundary` as the primary diagnostic target for `reason_about_indexed_scans` in `arrays_and_strings`.
