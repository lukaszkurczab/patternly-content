...
futureCanonicalSourcePath: "manual/source/algorithms/dynamic-programming-intro/iteration-order.json"
...
Teach `choose_dependency_safe_iteration_order` as the primary diagnostic target for `iteration_order` in `dynamic_programming_intro`.
