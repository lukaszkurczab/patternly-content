...
const DESIGN_TRUST_ROOT_SHA256 = "d292c93a722e15a7d47af4b8a563fbc9dd3aad425ddaa4add5b11f49768ff8ec";
const DESIGN_FAMILY_CONTRACT_SHA256 = "27de027e29f5ff99d87bd12633ae87f57d04615215d823cf88d21e370582878a";
...
const EXPECTED_RESOLVED_BY_TRACK = Object.freeze({
  "backend-system-design-interview": 72,
  "frontend-system-design-interview": 121,
  "object-oriented-design-interview": 48
});
...
function assertRegistry(value = registry, { repositoryRoot: root = repositoryRoot } = {}) {
  ...
  if (value.sourceRecords.length !== 112 || value.sourceCaptures.length !== 70 || value.anchorRecords.length !== 310 || value.claims.length !== 219 || value.slotBindings.length !== 241) fail("INVALID_DESIGN_SOURCE_REGISTRY_TOTAL", "frozen derived totals");
