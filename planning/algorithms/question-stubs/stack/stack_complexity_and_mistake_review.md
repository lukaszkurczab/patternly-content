...
roadmapNodeId: "stack"
unitKind: "direct"
unitId: "stack_complexity_and_mistake_review"
contentOwnership: "direct"
primaryPatternFamilyId: "stack"
legalPatternFamilyIds:
  - "stack"
primarySkillAtomId: "explain_amortized_stack_processing"
...
futureCanonicalSourcePath: "manual/source/algorithms/stack/stack-complexity-and-mistake-review.json"
...
Teach `explain_amortized_stack_processing` as the primary diagnostic target for `stack_complexity_and_mistake_review` in `stack`.
