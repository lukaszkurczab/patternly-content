...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-hash-map-vs-sorting/transfer-hash-map-vs-sorting.json"
...
Teach `transfer_hash_vs_sorting_decision` as the primary diagnostic target for `transfer_hash_map_vs_sorting` in `contrast_hash_map_vs_sorting`.
