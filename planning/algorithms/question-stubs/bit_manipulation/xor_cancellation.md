...
futureCanonicalSourcePath: "manual/source/algorithms/bit-manipulation/xor-cancellation.json"
...
Teach `apply_xor_cancellation` as the primary diagnostic target for `xor_cancellation` in `bit_manipulation`.
