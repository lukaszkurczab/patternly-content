...
unitKind: "direct"
unitId: "difference_array_updates"
contentOwnership: "direct"
primaryPatternFamilyId: "prefix_sums"
legalPatternFamilyIds:
  - "prefix_sums"
primarySkillAtomId: "encode_range_updates_by_differences"
...
futureCanonicalSourcePath: "manual/source/algorithms/prefix-sums/difference-array-updates.json"
...
Teach `encode_range_updates_by_differences` as the primary diagnostic target for `difference_array_updates` in `prefix_sums`.
