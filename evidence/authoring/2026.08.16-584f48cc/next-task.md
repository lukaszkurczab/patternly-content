...
1. Run `npm ci`.
2. Run `npm run authoring:validate`. If the input fingerprint differs from `3256850023d7ffae212332b7c3e09cf018690d0415e9fdeea0926b550bbbb5b2`, regenerate the plan and review the changed evidence before continuing.
