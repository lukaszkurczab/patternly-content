...
legalPatternFamilyIds:
  - "graph_traversal"
primarySkillAtomId: "traverse_graph_breadth_first"
...
futureCanonicalSourcePath: "manual/source/algorithms/graph-traversal/graph-bfs.json"
...
Teach `traverse_graph_breadth_first` as the primary diagnostic target for `graph_bfs` in `graph_traversal`.
