...
unitKind: "strategy"
unitId: "generate_candidate_strategies"
...
legalPatternFamilyIds:
  ...
  - "monotonic_stack"
  - "binary_search"
primarySkillAtomId: "generate_plausible_algorithmic_approaches"
...
futureCanonicalSourcePath: "manual/source/algorithms/strategy-selection-core/generate-candidate-strategies.json"
...
Teach `generate_plausible_algorithmic_approaches` as the primary diagnostic target for `generate_candidate_strategies` in `strategy_selection_core`.
