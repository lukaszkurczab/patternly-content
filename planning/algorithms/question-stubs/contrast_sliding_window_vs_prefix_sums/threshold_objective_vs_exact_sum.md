...
unitKind: "contrast"
unitId: "threshold_objective_vs_exact_sum"
contentOwnership: "cross_family"
primaryPatternFamilyId: "sliding_window"
legalPatternFamilyIds:
  - "sliding_window"
  - "prefix_sums"
primarySkillAtomId: "distinguish_threshold_window_from_exact_sum_prefix"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-sliding-window-vs-prefix-sums/threshold-objective-vs-exact-sum.json"
...
Teach `distinguish_threshold_window_from_exact_sum_prefix` as the primary diagnostic target for `threshold_objective_vs_exact_sum` in `contrast_sliding_window_vs_prefix_sums`.
