...
futureCanonicalSourcePath: "manual/source/algorithms/heap-priority-queue/heap-push-pop-peek-mechanics.json"
...
Teach `trace_heap_operation` as the primary diagnostic target for `heap_push_pop_peek_mechanics` in `heap_priority_queue`.
