...
unitKind: "direct"
unitId: "invalid_window_signals"
contentOwnership: "direct"
primaryPatternFamilyId: "sliding_window"
legalPatternFamilyIds:
  - "sliding_window"
primarySkillAtomId: "detect_simple_window_failure_signal"
...
futureCanonicalSourcePath: "manual/source/algorithms/sliding-window/invalid-window-signals.json"
...
Teach `detect_simple_window_failure_signal` as the primary diagnostic target for `invalid_window_signals` in `sliding_window`.
