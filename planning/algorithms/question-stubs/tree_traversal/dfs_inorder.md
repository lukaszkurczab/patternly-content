...
legalPatternFamilyIds:
  - "tree_traversal"
primarySkillAtomId: "apply_inorder_processing"
...
futureCanonicalSourcePath: "manual/source/algorithms/tree-traversal/dfs-inorder.json"
...
Teach `apply_inorder_processing` as the primary diagnostic target for `dfs_inorder` in `tree_traversal`.
