...
futureCanonicalSourcePath: "manual/source/algorithms/dynamic-programming-intro/optimize-state-space.json"
...
Teach `compress_dp_state_safely` as the primary diagnostic target for `optimize_state_space` in `dynamic_programming_intro`.
