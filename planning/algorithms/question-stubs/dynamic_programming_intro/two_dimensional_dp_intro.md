...
futureCanonicalSourcePath: "manual/source/algorithms/dynamic-programming-intro/two-dimensional-dp-intro.json"
...
Teach `model_two_dimensional_dp` as the primary diagnostic target for `two_dimensional_dp_intro` in `dynamic_programming_intro`.
