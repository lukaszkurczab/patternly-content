...
unitKind: "direct"
unitId: "build_one_dimensional_prefix"
contentOwnership: "direct"
primaryPatternFamilyId: "prefix_sums"
legalPatternFamilyIds:
  - "prefix_sums"
primarySkillAtomId: "construct_prefix_accumulation"
...
futureCanonicalSourcePath: "manual/source/algorithms/prefix-sums/build-one-dimensional-prefix.json"
...
Teach `construct_prefix_accumulation` as the primary diagnostic target for `build_one_dimensional_prefix` in `prefix_sums`.
