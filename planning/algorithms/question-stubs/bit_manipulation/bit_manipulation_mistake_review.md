...
unitKind: "direct"
unitId: "bit_manipulation_mistake_review"
contentOwnership: "direct"
primaryPatternFamilyId: "bit_manipulation"
legalPatternFamilyIds:
  - "bit_manipulation"
primarySkillAtomId: "diagnose_bit_width_or_sign_assumption"
...
futureCanonicalSourcePath: "manual/source/algorithms/bit-manipulation/bit-manipulation-mistake-review.json"
...
Teach `diagnose_bit_width_or_sign_assumption` as the primary diagnostic target for `bit_manipulation_mistake_review` in `bit_manipulation`.
