...
unitKind: "direct"
unitId: "frequency_and_seen_state"
...
futureCanonicalSourcePath: "manual/source/algorithms/arrays-and-strings/frequency-and-seen-state.json"
...
Teach `choose_frequency_state` as the primary diagnostic target for `frequency_and_seen_state` in `arrays_and_strings`.
