...
unitKind: "direct"
unitId: "recognize_greedy_candidate"
contentOwnership: "direct"
primaryPatternFamilyId: "greedy_intro"
legalPatternFamilyIds:
  - "greedy_intro"
primarySkillAtomId: "identify_greedy_choice_structure"
...
futureCanonicalSourcePath: "manual/source/algorithms/greedy-intro/recognize-greedy-candidate.json"
...
Teach `identify_greedy_choice_structure` as the primary diagnostic target for `recognize_greedy_candidate` in `greedy_intro`.
