...
unitKind: "direct"
unitId: "recursion_stack_and_complexity"
contentOwnership: "direct"
primaryPatternFamilyId: "recursion_basics"
legalPatternFamilyIds:
  - "recursion_basics"
primarySkillAtomId: "account_for_recursive_call_stack"
...
futureCanonicalSourcePath: "manual/source/algorithms/recursion-basics/recursion-stack-and-complexity.json"
...
Teach `account_for_recursive_call_stack` as the primary diagnostic target for `recursion_stack_and_complexity` in `recursion_basics`.
