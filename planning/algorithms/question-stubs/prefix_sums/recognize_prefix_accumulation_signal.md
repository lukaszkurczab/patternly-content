...
unitKind: "direct"
unitId: "recognize_prefix_accumulation_signal"
contentOwnership: "direct"
primaryPatternFamilyId: "prefix_sums"
legalPatternFamilyIds:
  - "prefix_sums"
primarySkillAtomId: "identify_reusable_prefix_state"
...
futureCanonicalSourcePath: "manual/source/algorithms/prefix-sums/recognize-prefix-accumulation-signal.json"
...
Teach `identify_reusable_prefix_state` as the primary diagnostic target for `recognize_prefix_accumulation_signal` in `prefix_sums`.
