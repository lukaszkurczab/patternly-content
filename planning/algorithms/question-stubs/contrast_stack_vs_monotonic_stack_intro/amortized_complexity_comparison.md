...
unitKind: "contrast"
unitId: "amortized_complexity_comparison"
contentOwnership: "cross_family"
primaryPatternFamilyId: "stack"
legalPatternFamilyIds:
  - "stack"
  - "monotonic_stack"
primarySkillAtomId: "compare_stack_variant_amortized_complexity"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-stack-vs-monotonic-stack-intro/amortized-complexity-comparison.json"
...
Teach `compare_stack_variant_amortized_complexity` as the primary diagnostic target for `amortized_complexity_comparison` in `contrast_stack_vs_monotonic_stack_intro`.
