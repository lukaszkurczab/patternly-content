...
unitKind: "direct"
unitId: "derive_space_complexity"
...
futureCanonicalSourcePath: "manual/source/algorithms/complexity-and-constraints/derive-space-complexity.json"
...
Teach `derive_space_complexity` as the primary diagnostic target for `derive_space_complexity` in `complexity_and_constraints`.
