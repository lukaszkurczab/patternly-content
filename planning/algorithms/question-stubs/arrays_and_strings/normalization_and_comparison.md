...
futureCanonicalSourcePath: "manual/source/algorithms/arrays-and-strings/normalization-and-comparison.json"
...
Teach `apply_sequence_normalization` as the primary diagnostic target for `normalization_and_comparison` in `arrays_and_strings`.
