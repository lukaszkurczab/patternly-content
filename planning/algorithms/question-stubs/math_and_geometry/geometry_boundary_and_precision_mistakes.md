...
unitKind: "direct"
unitId: "geometry_boundary_and_precision_mistakes"
contentOwnership: "direct"
primaryPatternFamilyId: "math_and_geometry"
legalPatternFamilyIds:
  - "math_and_geometry"
primarySkillAtomId: "diagnose_degenerate_or_precision_case"
...
futureCanonicalSourcePath: "manual/source/algorithms/math-and-geometry/geometry-boundary-and-precision-mistakes.json"
...
Teach `diagnose_degenerate_or_precision_case` as the primary diagnostic target for `geometry_boundary_and_precision_mistakes` in `math_and_geometry`.
