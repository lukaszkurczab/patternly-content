...
unitKind: "direct"
unitId: "frequency_constrained_window"
contentOwnership: "direct"
primaryPatternFamilyId: "sliding_window"
legalPatternFamilyIds:
  - "sliding_window"
primarySkillAtomId: "maintain_frequency_constrained_window"
...
futureCanonicalSourcePath: "manual/source/algorithms/sliding-window/frequency-constrained-window.json"
...
Teach `maintain_frequency_constrained_window` as the primary diagnostic target for `frequency_constrained_window` in `sliding_window`.
