...
futureCanonicalSourcePath: "manual/source/algorithms/backtracking/enumerate-choices.json"
...
Teach `enumerate_legal_next_choices` as the primary diagnostic target for `enumerate_choices` in `backtracking`.
