...
unitKind: "direct"
unitId: "greedy_mistake_review"
contentOwnership: "direct"
primaryPatternFamilyId: "greedy_intro"
legalPatternFamilyIds:
  - "greedy_intro"
primarySkillAtomId: "diagnose_unsupported_greedy_reasoning"
...
futureCanonicalSourcePath: "manual/source/algorithms/greedy-intro/greedy-mistake-review.json"
...
Teach `diagnose_unsupported_greedy_reasoning` as the primary diagnostic target for `greedy_mistake_review` in `greedy_intro`.
