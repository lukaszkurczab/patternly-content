...
unitKind: "direct"
unitId: "sorted_input_precondition"
contentOwnership: "direct"
primaryPatternFamilyId: "two_pointers"
legalPatternFamilyIds:
  - "two_pointers"
primarySkillAtomId: "validate_sorted_input_dependency"
...
futureCanonicalSourcePath: "manual/source/algorithms/two-pointers/sorted-input-precondition.json"
...
Teach `validate_sorted_input_dependency` as the primary diagnostic target for `sorted_input_precondition` in `two_pointers`.
