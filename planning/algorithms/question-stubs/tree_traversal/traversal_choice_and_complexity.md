...
unitKind: "direct"
unitId: "traversal_choice_and_complexity"
contentOwnership: "direct"
primaryPatternFamilyId: "tree_traversal"
legalPatternFamilyIds:
  - "tree_traversal"
primarySkillAtomId: "choose_tree_traversal_order"
...
futureCanonicalSourcePath: "manual/source/algorithms/tree-traversal/traversal-choice-and-complexity.json"
...
Teach `choose_tree_traversal_order` as the primary diagnostic target for `traversal_choice_and_complexity` in `tree_traversal`.
