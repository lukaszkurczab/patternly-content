...
roadmapNodeId: "stack"
unitKind: "direct"
unitId: "next_greater_smaller_boundaries"
contentOwnership: "direct"
primaryPatternFamilyId: "monotonic_stack"
legalPatternFamilyIds:
  - "monotonic_stack"
primarySkillAtomId: "resolve_nearest_greater_or_smaller"
...
futureCanonicalSourcePath: "manual/source/algorithms/stack/next-greater-smaller-boundaries.json"
...
Teach `resolve_nearest_greater_or_smaller` as the primary diagnostic target for `next_greater_smaller_boundaries` in `stack`.
