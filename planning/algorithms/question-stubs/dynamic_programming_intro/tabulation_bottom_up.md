...
futureCanonicalSourcePath: "manual/source/algorithms/dynamic-programming-intro/tabulation-bottom-up.json"
...
Teach `tabulate_subproblems_bottom_up` as the primary diagnostic target for `tabulation_bottom_up` in `dynamic_programming_intro`.
