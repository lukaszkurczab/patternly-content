...
futureCanonicalSourcePath: "manual/source/algorithms/binary-search/classic-index-search.json"
...
Teach `maintain_classic_search_invariant` as the primary diagnostic target for `classic_index_search` in `binary_search`.
