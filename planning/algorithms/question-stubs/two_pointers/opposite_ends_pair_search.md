...
unitKind: "direct"
unitId: "opposite_ends_pair_search"
...
futureCanonicalSourcePath: "manual/source/algorithms/two-pointers/opposite-ends-pair-search.json"
...
Teach `move_decisive_pointer` as the primary diagnostic target for `opposite_ends_pair_search` in `two_pointers`.
