...
unitKind: "direct"
unitId: "window_complexity_and_mistake_review"
contentOwnership: "direct"
primaryPatternFamilyId: "sliding_window"
legalPatternFamilyIds:
  - "sliding_window"
primarySkillAtomId: "explain_linear_window_complexity"
...
futureCanonicalSourcePath: "manual/source/algorithms/sliding-window/window-complexity-and-mistake-review.json"
...
Teach `explain_linear_window_complexity` as the primary diagnostic target for `window_complexity_and_mistake_review` in `sliding_window`.
