...
const fixtureModeConfiguration = {
  ...
  practiceBlueprints: [
    { blueprintId: "fixture-learn", blueprintVersion: "1", modeId: "algorithms-learn-approach", requestedLengths: [10], defaultRequestedLength: 10, shortening: "allowed", minimumActualLength: 1, selectionBoundary: "one_roadmap_node", reinsertPolicy: "disabled", learningStages: ["approach_model"] },
    { blueprintId: "fixture-guided", blueprintVersion: "1", modeId: "algorithms-guided-practice", requestedLengths: [10, 20, 40], defaultRequestedLength: 20, shortening: "allowed", minimumActualLength: 1, selectionBoundary: "one_roadmap_node", reinsertPolicy: "enabled", learningStages: ["guided_application"] },
    { blueprintId: "fixture-recognition", blueprintVersion: "1", modeId: "algorithms-recognize-patterns", requestedLengths: [10, 20], defaultRequestedLength: 20, shortening: "allowed", minimumActualLength: 1, selectionBoundary: "explicit_recognition_scope", reinsertPolicy: "disabled", learningStages: ["recognition"] },
    { blueprintId: "fixture-contrast", blueprintVersion: "1", modeId: "algorithms-contrast-practice", requestedLengths: [10, 20], defaultRequestedLength: 20, shortening: "allowed", minimumActualLength: 1, selectionBoundary: "contrast_roadmap_topic", reinsertPolicy: "disabled", learningStages: ["contrast"] },
    ...
    { blueprintId: "fixture-independent", blueprintVersion: "1", modeId: "algorithms-independent-practice", requestedLengths: [10, 20], defaultRequestedLength: 20, shortening: "blueprint_controlled", minimumActualLength: 1, selectionBoundary: "explicit_interleaved_scope", reinsertPolicy: "disabled", learningStages: ["independent_transfer"] },
  ],
  ...
  userModeMappings: [
    { userModeId: "algorithms-learn-approach", blueprintModeId: "algorithms-learn-approach" }, { userModeId: "algorithms-guided-practice", blueprintModeId: "algorithms-guided-practice" }, { userModeId: "algorithms-custom-practice", blueprintModeId: "algorithms-guided-practice" }, { userModeId: "algorithms-recognize-patterns", blueprintModeId: "algorithms-recognize-patterns" }, { userModeId: "algorithms-contrast-practice", blueprintModeId: "algorithms-contrast-practice" }, { userModeId: "algorithms-weak-area-review", blueprintModeId: "algorithms-weak-area-review" }, { userModeId: "algorithms-independent-practice", blueprintModeId: "algorithms-independent-practice" }, { userModeId: "algorithms-interview-simulation", blueprintModeId: "algorithms-interview-simulation" },
  ],
};
...
export function certificationBatch({ count = 60 } = {}) { return { schemaVersion: "certification-manual-source-v1", batchId: "fixture-certification-batch", trackId: "cloud-certification", familyId: "certification", contentVersion: "certification-fixture-v1", taxonomyVersion: "cloud-certification-taxonomy-v1", declaredModes: ["certification-diagnostic-baseline", "certification-focus-practice", "certification-scenario-practice", "certification-weak-area-review", "certification-mixed-practice", "certification-quick-review", "certification-exam-simulation"], items: Array.from({ length: count }, (_, index) => ({ id: `fixture-certification-${index + 1}`, domain: "setup_environment", type: "single", difficulty: "easy", question: `Fixture certification question ${index + 1}?`, options: [{ id: "A", text: `Correct ${index + 1}` }, { id: "B", text: `Wrong B ${index + 1}` }, { id: "C", text: `Wrong C ${index + 1}` }, { id: "D", text: `Wrong D ${index + 1}` }], correctOptionIds: ["A"], feedback: { reason: "Fixture explanation.", details: { blocks: [{ type: "paragraph", text: "Fixture watch-out." }] }, wrongOptionExplanationsByOptionId: { B: "Wrong B.", C: "Wrong C.", D: "Wrong D." } }, tags: ["fixture"], examSignals: ["fixture"] })) }; }
