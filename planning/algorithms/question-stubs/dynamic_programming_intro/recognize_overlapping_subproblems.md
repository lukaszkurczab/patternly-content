...
futureCanonicalSourcePath: "manual/source/algorithms/dynamic-programming-intro/recognize-overlapping-subproblems.json"
...
Teach `identify_reused_subproblem` as the primary diagnostic target for `recognize_overlapping_subproblems` in `dynamic_programming_intro`.
