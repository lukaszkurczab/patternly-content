...
unitKind: "contrast"
unitId: "one_query_vs_many_queries"
contentOwnership: "cross_family"
primaryPatternFamilyId: "sliding_window"
legalPatternFamilyIds:
  - "sliding_window"
  - "prefix_sums"
primarySkillAtomId: "choose_window_or_prefix_for_query_volume"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-sliding-window-vs-prefix-sums/one-query-vs-many-queries.json"
...
Teach `choose_window_or_prefix_for_query_volume` as the primary diagnostic target for `one_query_vs_many_queries` in `contrast_sliding_window_vs_prefix_sums`.
