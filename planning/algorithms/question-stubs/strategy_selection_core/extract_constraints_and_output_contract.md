...
unitKind: "strategy"
unitId: "extract_constraints_and_output_contract"
...
legalPatternFamilyIds:
  ...
  - "monotonic_stack"
  - "binary_search"
primarySkillAtomId: "extract_strategy_decision_signals"
...
futureCanonicalSourcePath: "manual/source/algorithms/strategy-selection-core/extract-constraints-and-output-contract.json"
...
Teach `extract_strategy_decision_signals` as the primary diagnostic target for `extract_constraints_and_output_contract` in `strategy_selection_core`.
