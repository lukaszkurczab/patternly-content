...
unitKind: "contrast"
unitId: "fixed_state_vs_variable_window_state"
contentOwnership: "cross_family"
primaryPatternFamilyId: "two_pointers"
legalPatternFamilyIds:
  - "two_pointers"
  - "sliding_window"
primarySkillAtomId: "distinguish_fixed_pointer_state_from_window_state"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-two-pointers-vs-sliding-window/fixed-state-vs-variable-window-state.json"
...
Teach `distinguish_fixed_pointer_state_from_window_state` as the primary diagnostic target for `fixed_state_vs_variable_window_state` in `contrast_two_pointers_vs_sliding_window`.
