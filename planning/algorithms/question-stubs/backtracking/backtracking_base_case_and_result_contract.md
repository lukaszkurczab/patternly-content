...
unitKind: "direct"
unitId: "backtracking_base_case_and_result_contract"
contentOwnership: "direct"
primaryPatternFamilyId: "backtracking"
legalPatternFamilyIds:
  - "backtracking"
primarySkillAtomId: "define_backtracking_completion_contract"
...
futureCanonicalSourcePath: "manual/source/algorithms/backtracking/backtracking-base-case-and-result-contract.json"
...
Teach `define_backtracking_completion_contract` as the primary diagnostic target for `backtracking_base_case_and_result_contract` in `backtracking`.
