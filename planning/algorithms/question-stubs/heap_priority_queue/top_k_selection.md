...
futureCanonicalSourcePath: "manual/source/algorithms/heap-priority-queue/top-k-selection.json"
...
Teach `maintain_bounded_top_k_heap` as the primary diagnostic target for `top_k_selection` in `heap_priority_queue`.
