...
futureCanonicalSourcePath: "manual/source/algorithms/graph-traversal/visited-state-and-cycles.json"
...
Teach `maintain_graph_visited_state` as the primary diagnostic target for `visited_state_and_cycles` in `graph_traversal`.
