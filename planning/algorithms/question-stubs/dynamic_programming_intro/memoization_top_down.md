...
futureCanonicalSourcePath: "manual/source/algorithms/dynamic-programming-intro/memoization-top-down.json"
...
Teach `memoize_recursive_subproblem` as the primary diagnostic target for `memoization_top_down` in `dynamic_programming_intro`.
