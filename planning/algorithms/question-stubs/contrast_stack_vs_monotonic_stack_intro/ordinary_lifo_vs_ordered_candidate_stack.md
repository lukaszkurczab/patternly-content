...
unitKind: "contrast"
unitId: "ordinary_lifo_vs_ordered_candidate_stack"
contentOwnership: "cross_family"
primaryPatternFamilyId: "stack"
legalPatternFamilyIds:
  - "stack"
  - "monotonic_stack"
primarySkillAtomId: "distinguish_lifo_stack_from_monotonic_candidate_stack"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-stack-vs-monotonic-stack-intro/ordinary-lifo-vs-ordered-candidate-stack.json"
...
Teach `distinguish_lifo_stack_from_monotonic_candidate_stack` as the primary diagnostic target for `ordinary_lifo_vs_ordered_candidate_stack` in `contrast_stack_vs_monotonic_stack_intro`.
