...
unitKind: "contrast"
unitId: "memory_vs_mutation_tradeoff"
contentOwnership: "cross_family"
primaryPatternFamilyId: "hash_map_and_set"
legalPatternFamilyIds:
  - "hash_map_and_set"
  - "sorting_based"
primarySkillAtomId: "compare_hash_memory_with_sort_mutation"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-hash-map-vs-sorting/memory-vs-mutation-tradeoff.json"
...
Teach `compare_hash_memory_with_sort_mutation` as the primary diagnostic target for `memory_vs_mutation_tradeoff` in `contrast_hash_map_vs_sorting`.
