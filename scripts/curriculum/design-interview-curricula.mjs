...
const DESIGN_TRUST_ROOT_SHA256 = "ab6a6977b942c425dbb336f4278cfc69ed1ffe08c6bc1e54511dbbd343241628";
const DESIGN_FAMILY_CONTRACT_SHA256 = "1cfd8b1e8d3fa9773067df9626a6815752e71af46071572f8b59beaa0500dad6";
...
const EXPECTED_RESOLVED_BY_TRACK = Object.freeze({
  ...
  "frontend-system-design-interview": 133,
...
function assertRegistry(value = registry, { repositoryRoot: root = repositoryRoot } = {}) {
  ...
  if (value.sourceRecords.length !== 120 || value.sourceCaptures.length !== 78 || value.anchorRecords.length !== 334 || value.claims.length !== 234 || value.slotBindings.length !== 257) fail("INVALID_DESIGN_SOURCE_REGISTRY_TOTAL", "frozen derived totals");
