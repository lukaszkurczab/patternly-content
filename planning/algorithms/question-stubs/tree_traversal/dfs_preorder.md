...
legalPatternFamilyIds:
  - "tree_traversal"
primarySkillAtomId: "apply_preorder_processing"
...
futureCanonicalSourcePath: "manual/source/algorithms/tree-traversal/dfs-preorder.json"
...
Teach `apply_preorder_processing` as the primary diagnostic target for `dfs_preorder` in `tree_traversal`.
