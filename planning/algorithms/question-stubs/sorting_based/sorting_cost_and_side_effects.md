...
unitKind: "direct"
unitId: "sorting_cost_and_side_effects"
contentOwnership: "direct"
primaryPatternFamilyId: "sorting_based"
legalPatternFamilyIds:
  - "sorting_based"
primarySkillAtomId: "account_for_sorting_cost_and_mutation"
...
futureCanonicalSourcePath: "manual/source/algorithms/sorting-based/sorting-cost-and-side-effects.json"
...
Teach `account_for_sorting_cost_and_mutation` as the primary diagnostic target for `sorting_cost_and_side_effects` in `sorting_based`.
