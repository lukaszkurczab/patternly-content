...
futureCanonicalSourcePath: "manual/source/algorithms/hash-map-and-set/complement-lookup.json"
...
Teach `derive_complement_lookup` as the primary diagnostic target for `complement_lookup` in `hash_map_and_set`.
