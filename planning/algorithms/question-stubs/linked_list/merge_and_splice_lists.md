...
unitKind: "direct"
unitId: "merge_and_splice_lists"
contentOwnership: "direct"
primaryPatternFamilyId: "linked_list"
legalPatternFamilyIds:
  - "linked_list"
primarySkillAtomId: "merge_nodes_without_losing_links"
...
futureCanonicalSourcePath: "manual/source/algorithms/linked-list/merge-and-splice-lists.json"
...
Teach `merge_nodes_without_losing_links` as the primary diagnostic target for `merge_and_splice_lists` in `linked_list`.
