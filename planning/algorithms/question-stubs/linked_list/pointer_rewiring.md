...
unitKind: "direct"
unitId: "pointer_rewiring"
contentOwnership: "direct"
primaryPatternFamilyId: "linked_list"
legalPatternFamilyIds:
  - "linked_list"
primarySkillAtomId: "preserve_reachable_nodes_during_rewire"
...
futureCanonicalSourcePath: "manual/source/algorithms/linked-list/pointer-rewiring.json"
...
Teach `preserve_reachable_nodes_during_rewire` as the primary diagnostic target for `pointer_rewiring` in `linked_list`.
