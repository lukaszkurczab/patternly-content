...
unitKind: "contrast"
unitId: "shrink_legality_and_monotonicity"
contentOwnership: "cross_family"
primaryPatternFamilyId: "two_pointers"
legalPatternFamilyIds:
  - "two_pointers"
  - "sliding_window"
primarySkillAtomId: "validate_window_shrink_monotonicity"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-two-pointers-vs-sliding-window/shrink-legality-and-monotonicity.json"
...
Teach `validate_window_shrink_monotonicity` as the primary diagnostic target for `shrink_legality_and_monotonicity` in `contrast_two_pointers_vs_sliding_window`.
