...
unitKind: "contrast"
unitId: "transfer_two_pointers_vs_sliding_window"
contentOwnership: "cross_family"
primaryPatternFamilyId: "two_pointers"
legalPatternFamilyIds:
  - "two_pointers"
  - "sliding_window"
primarySkillAtomId: "transfer_two_pointers_vs_window_decision"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-two-pointers-vs-sliding-window/transfer-two-pointers-vs-sliding-window.json"
...
Teach `transfer_two_pointers_vs_window_decision` as the primary diagnostic target for `transfer_two_pointers_vs_sliding_window` in `contrast_two_pointers_vs_sliding_window`.
