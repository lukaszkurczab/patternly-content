...
unitKind: "direct"
unitId: "recursion_base_case_and_result_contract"
contentOwnership: "direct"
primaryPatternFamilyId: "recursion_basics"
legalPatternFamilyIds:
  - "recursion_basics"
primarySkillAtomId: "define_recursive_base_and_return_contract"
...
futureCanonicalSourcePath: "manual/source/algorithms/recursion-basics/recursion-base-case-and-result-contract.json"
...
Teach `define_recursive_base_and_return_contract` as the primary diagnostic target for `recursion_base_case_and_result_contract` in `recursion_basics`.
