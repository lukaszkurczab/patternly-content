...
unitKind: "direct"
unitId: "partitioning_and_segmentation"
contentOwnership: "direct"
primaryPatternFamilyId: "backtracking"
legalPatternFamilyIds:
  - "backtracking"
primarySkillAtomId: "choose_partition_boundary"
...
futureCanonicalSourcePath: "manual/source/algorithms/backtracking/partitioning-and-segmentation.json"
...
Teach `choose_partition_boundary` as the primary diagnostic target for `partitioning_and_segmentation` in `backtracking`.
