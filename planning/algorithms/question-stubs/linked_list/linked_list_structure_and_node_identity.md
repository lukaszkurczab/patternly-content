...
unitKind: "direct"
unitId: "linked_list_structure_and_node_identity"
contentOwnership: "direct"
primaryPatternFamilyId: "linked_list"
legalPatternFamilyIds:
  - "linked_list"
primarySkillAtomId: "distinguish_node_identity_from_node_value"
...
futureCanonicalSourcePath: "manual/source/algorithms/linked-list/linked-list-structure-and-node-identity.json"
...
Teach `distinguish_node_identity_from_node_value` as the primary diagnostic target for `linked_list_structure_and_node_identity` in `linked_list`.
