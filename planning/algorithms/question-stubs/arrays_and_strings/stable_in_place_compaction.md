...
futureCanonicalSourcePath: "manual/source/algorithms/arrays-and-strings/stable-in-place-compaction.json"
...
Teach `maintain_read_write_boundary` as the primary diagnostic target for `stable_in_place_compaction` in `arrays_and_strings`.
