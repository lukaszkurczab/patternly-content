...
futureCanonicalSourcePath: "manual/source/algorithms/linked-list/cycle-detection.json"
...
Teach `detect_cycle_by_pointer_convergence` as the primary diagnostic target for `cycle_detection` in `linked_list`.
