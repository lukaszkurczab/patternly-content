...
futureCanonicalSourcePath: "manual/source/algorithms/sliding-window/fixed-size-window.json"
...
Teach `maintain_fixed_size_window_state` as the primary diagnostic target for `fixed_size_window` in `sliding_window`.
