...
const DESIGN_TRUST_ROOT_SHA256 = "6e25c2a1e9091bf07e92502b5e9fbbc6c3edb7ac2c90a59d4b8bccac27ebd7ba";
const DESIGN_FAMILY_CONTRACT_SHA256 = "84edcc0e822520f3335b92111d1c0e78616b9386764a16670e2ded7c53233ae1";
...
const EXPECTED_RESOLVED_BY_TRACK = Object.freeze({
  ...
  "frontend-system-design-interview": 131,
...
function assertRegistry(value = registry, { repositoryRoot: root = repositoryRoot } = {}) {
  ...
  if (value.sourceRecords.length !== 119 || value.sourceCaptures.length !== 77 || value.anchorRecords.length !== 332 || value.claims.length !== 232 || value.slotBindings.length !== 255) fail("INVALID_DESIGN_SOURCE_REGISTRY_TOTAL", "frozen derived totals");
