...
function nodeInventory(node, items) {
  ...
  return { nodeId: node.nodeId, mentalUnitCount: new Set(nodeItems.map((item) => item.mentalUnitId)).size, questionCount: nodeItems.length, workingRange: [node.workingLow, node.workingHigh], coverage: "PASS", validation: "PASS", semanticDuplicateAudit: "PASS", fillerAudit: "PASS", saturationAudit: "PASS", humanReview: "PENDING" };
}
