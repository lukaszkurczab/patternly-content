...
unitKind: "direct"
unitId: "carry_path_and_aggregate_state"
contentOwnership: "direct"
primaryPatternFamilyId: "tree_traversal"
legalPatternFamilyIds:
  - "tree_traversal"
primarySkillAtomId: "carry_state_along_tree_path"
...
futureCanonicalSourcePath: "manual/source/algorithms/tree-traversal/carry-path-and-aggregate-state.json"
...
Teach `carry_state_along_tree_path` as the primary diagnostic target for `carry_path_and_aggregate_state` in `tree_traversal`.
