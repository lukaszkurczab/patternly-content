...
unitKind: "contrast"
unitId: "legal_half_discard_rule"
contentOwnership: "cross_family"
primaryPatternFamilyId: "binary_search"
legalPatternFamilyIds:
  - "binary_search"
  - "arrays_and_strings"
primarySkillAtomId: "compare_half_discard_rule_with_linear_scan"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-binary-search-vs-linear-scan/legal-half-discard-rule.json"
...
Teach `compare_half_discard_rule_with_linear_scan` as the primary diagnostic target for `legal_half_discard_rule` in `contrast_binary_search_vs_linear_scan`.
