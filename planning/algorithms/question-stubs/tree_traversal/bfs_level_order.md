...
futureCanonicalSourcePath: "manual/source/algorithms/tree-traversal/bfs-level-order.json"
...
Teach `process_tree_by_levels` as the primary diagnostic target for `bfs_level_order` in `tree_traversal`.
