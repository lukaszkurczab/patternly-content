...
unitKind: "contrast"
unitId: "monotonic_predicate_vs_arbitrary_condition"
contentOwnership: "cross_family"
primaryPatternFamilyId: "binary_search"
legalPatternFamilyIds:
  - "binary_search"
  - "arrays_and_strings"
primarySkillAtomId: "distinguish_monotonic_predicate_from_arbitrary_condition"
...
futureCanonicalSourcePath: "manual/source/algorithms/contrast-binary-search-vs-linear-scan/monotonic-predicate-vs-arbitrary-condition.json"
...
Teach `distinguish_monotonic_predicate_from_arbitrary_condition` as the primary diagnostic target for `monotonic_predicate_vs_arbitrary_condition` in `contrast_binary_search_vs_linear_scan`.
