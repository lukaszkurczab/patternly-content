...
futureCanonicalSourcePath: "manual/source/algorithms/bit-manipulation/shifts-and-sign-behavior.json"
...
Teach `reason_about_bit_shift_behavior` as the primary diagnostic target for `shifts_and_sign_behavior` in `bit_manipulation`.
