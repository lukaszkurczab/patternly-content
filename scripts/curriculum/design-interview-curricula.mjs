...
const DESIGN_TRUST_ROOT_SHA256 = "26ec72b18507a4849a7f989ad754e69d86368f49a02676346389e675932b8b27";
const DESIGN_FAMILY_CONTRACT_SHA256 = "321a0de46af4e54d936682f33a01dd4276882183ebb9ffee49863559f4f009da";
...
const EXPECTED_RESOLVED_BY_TRACK = Object.freeze({
  "backend-system-design-interview": 74,
  "frontend-system-design-interview": 134,
  "object-oriented-design-interview": 50
});
...
const licenseEvidenceUrlBySourceId = Object.freeze({
  ...
  ,"microsoft-azure-monitor-telemetry-data-model-1930418e": "https://github.com/MicrosoftDocs/azure-monitor-docs/blob/1930418e2dee453a02d6edc12ea15adcd0c1f39d/LICENSE"
  ...
  ,"microsoft-waf-failure-mode-analysis-40aabbf": "https://github.com/MicrosoftDocs/well-architected/blob/40aabbf5a416b750d1c11fc9b5c85666c95b119a/LICENSE"
  ,"edge-webview2-versioning-dd024d8": "https://github.com/MicrosoftDocs/edge-developer/blob/dd024d8785db4c803a128cdde599e9287ee6ab5a/LICENSE"
  ,"aspnetcore-docs-blazor-virtualization-c67a801": "https://github.com/dotnet/AspNetCore.Docs/blob/c67a80103a1a74db20784debd919c7fdda96c510/LICENSE"
  ,"aspnetcore-docs-cookie-authentication-c67a801": "https://github.com/dotnet/AspNetCore.Docs/blob/c67a80103a1a74db20784debd919c7fdda96c510/LICENSE"
  ,"aspnetcore-docs-blazor-forms-validation-c67a801": "https://github.com/dotnet/AspNetCore.Docs/blob/c67a80103a1a74db20784debd919c7fdda96c510/LICENSE"
  ,"microsoft-sql-transaction-locking-guide-b356462": "https://github.com/MicrosoftDocs/sql-docs/blob/b356462c16cabe6450626f82dd769b521f002e70/LICENSE"
  ,"microsoft-dotnet-exception-best-practices-bd038508": "https://github.com/dotnet/docs/blob/bd038508933775b801ebfe58540634f4024bfdf0/LICENSE"
  ,"narayana-transactions-overview-b57a371": "https://github.com/jbosstm/narayana/blob/b57a371d5bdea7a5273b83cf7d8bf9aa77ecd769/LICENSE"
});
...
function assertCaptures(value, root = repositoryRoot) {
  ...
  if (value.sourceCaptures.length !== requiredCaptureSourceIds.length + c23CaptureSourceIds.length) fail("UNBOUND_DESIGN_SOURCE_CAPTURE", "source capture roster");
  if (!sameSet(sourceIds, new Set([...requiredCaptureSourceIds, ...c23CaptureSourceIds]))) fail("UNBOUND_DESIGN_SOURCE_CAPTURE", "exact capture sources");
...
function assertRegistry(value = registry, { repositoryRoot: root = repositoryRoot } = {}) {
  ...
  if (value.sourceRecords.length !== 121 || value.sourceCaptures.length !== 79 || value.anchorRecords.length !== 337 || value.claims.length !== 237 || value.slotBindings.length !== 258) fail("INVALID_DESIGN_SOURCE_REGISTRY_TOTAL", "frozen derived totals");
