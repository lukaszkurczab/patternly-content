...
unitKind: "direct"
unitId: "recognize_sorting_as_preprocessing"
contentOwnership: "direct"
primaryPatternFamilyId: "sorting_based"
legalPatternFamilyIds:
  - "sorting_based"
primarySkillAtomId: "identify_structure_revealed_by_sorting"
...
futureCanonicalSourcePath: "manual/source/algorithms/sorting-based/recognize-sorting-as-preprocessing.json"
...
Teach `identify_structure_revealed_by_sorting` as the primary diagnostic target for `recognize_sorting_as_preprocessing` in `sorting_based`.
